...
\begin{definition}{Tensors of Pointed Sets by Sets}{tensors-of-pointed-sets-by-sets}%
    ...
    %---  End Footnote  ---%
    of $(X,x_{0})$ by $A$ as in \ChapterRef{\ChapterWeightedLimitsAndColimits, \cref{weighted-limits-and-colimits:tensors}}{\cref{tensors}}.
\end{definition}
...
\begin{definition}{Cotensors of Pointed Sets by Sets}{cotensors-of-pointed-sets-by-sets}%
    ...
    %---  End Footnote  ---%
    of $(X,x_{0})$ by $A$ as in \ChapterRef{\ChapterWeightedLimitsAndColimits, \cref{weighted-limits-and-colimits:cotensors}}{\cref{cotensors}}.
\end{definition}
