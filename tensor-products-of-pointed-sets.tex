...
\begin{Proof}{Proof of \cref{monoids-with-respect-to-the-right-tensor-product-of-pointed-sets}}%
    ...
    \begin{enumerate}
        \item\label{proof-of-monoids-with-respect-to-the-right-tensor-product-of-pointed-sets-associativity-1}\SloganFont{Associativity. }The associativity condition acts as
            ...
            \]%
            for each $a,b,c\in A$.
        \item\label{proof-of-monoids-with-respect-to-the-left-tensor-product-of-pointed-sets-left-unitality-2}\SloganFont{Left Unitality. }The left unitality condition acts as
            \begin{webcompile}
                \begin{tikzcd}[row sep={5.0*\the\DL,between origins}, column sep={5.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    a
                    \arrow[d,mapsto]
...
\begin{Proof}{Proof of \cref{the-left-unitor-of-the-smash-product-of-pointed-sets}}%
    ...
    \begin{enumerate}
        \item\label{proof-of-the-left-unitor-of-the-smash-product-of-pointed-sets-1}\SloganFont{Invertibility \rmI. }We have
            \begin{align*}
            ...
            \[
                ...
                \id_{S^{0}\wedge X}.%
            \]%
        \item\label{proof-of-the-left-unitor-of-the-smash-product-of-pointed-sets-2}\SloganFont{Invertibility \rmII. }We have
            \begin{align*}
...
\begin{Proof}{Proof of \cref{the-right-unitor-of-the-smash-product-of-pointed-sets}}%
    ...
    for each $x\in X$. Indeed:
    \begin{enumerate}
        \item\label{proof-of-the-right-unitor-of-the-smash-product-of-pointed-sets-1}\SloganFont{Invertibility \rmI. }We have
            \begin{align*}
            ...
            \[
                ...
                \id_{X\wedge S^{0}}.%
            \]%
        \item\label{proof-of-the-right-unitor-of-the-smash-product-of-pointed-sets-2}\SloganFont{Invertibility \rmII. }We have
            \begin{align*}
