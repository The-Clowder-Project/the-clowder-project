...
\begin{example}{The Trivial Pointed Set}{the-trivial-pointed-set}%
    ...
    \end{itemize}
\end{example}
\begin{example}{The Underlying Pointed Set of a Semimodule}{the-underlying-pointed-set-of-a-semimodule}%
...
\end{example}
\begin{example}{The Underlying Pointed Set of a Module}{the-underlying-pointed-set-of-a-module}%
...
\begin{definition}{Morphisms of Pointed Sets}{morphisms-of-pointed-sets}%
    A \index[set-theory]{pointed set!morphism of}\textbf{morphism of pointed sets}%
    %--- Begin Footnote ---%
    \footnote{%
...
\begin{proposition}{Properties of Products of Pointed Sets}{properties-of-products-of-pointed-sets}%
    ...
    \begin{enumerate}
        \item\label{properties-of-products-of-pointed-sets-functoriality}\SloganFont{Functoriality. }The assignments
            ...
            \begin{gather*}
                \begin{aligned}
                    X\times-    &\colon                \Sets_{*} \to \Sets_{*},\\
                    -\times Y   &\colon \Sets_{*}                \to \Sets_{*},
                \end{aligned}\\
                -_{1}\times-_{2} \colon \Sets_{*}\times\Sets_{*} \to \Sets_{*},
            \end{gather*}
