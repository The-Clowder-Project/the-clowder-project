...
\begin{Proof}{Proof of \cref{properties-of-composition-of-relations}}%
    ...
    Indeed, we have
    \begin{align*}
        \chi_{B}\procirc R &\defeq \int^{b\in B}(\chi_{B})^{-_{1}}_{b}\times R^{b}_{-_{2}}\\
                           &=      \bigvee_{b\in B}(\chi_{B})^{-_{1}}_{b}\times R^{b}_{-_{2}}\\
                           &=      \bigvee_{\substack{b\in B\\b=-_{1}}}R^{b}_{-_{2}}\\
                           &=      R^{-_{1}}_{-_{2}},
    \end{align*}
    and
    \begin{align*}
        R\procirc\chi_{A} &\defeq \int^{a\in A}R^{-_{1}}_{a}\times(\chi_{A})^{a}_{-_{2}}\\
                          &=      \bigvee_{a\in B}R^{-_{1}}_{a}\times(\chi_{A})^{a}_{-_{2}}\\
