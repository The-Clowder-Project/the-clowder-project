...
\end{remark}
\subsection{Monomorphisms and 2-Categorical Monomorphisms}\label{subsection-monomorphisms-in-rel}
\begin{motivation}{Monomorphisms in $\sfRel$}{motivation-for-result-on-monomorphisms-in-rel}%
    ...
    \begin{itemize}
        ...
        \item \cref{characterisations-of-2-categorical-monomorphisms-in-rel} characterises the 2-categorical monomorphisms in $\sfbfRel$.%
            %--- Begin Footnote ---%
            \footnote{%
                As it turns out, these agree with the usual (1-categorical) notion of monomorphism.
                \par\vspace*{\TCBBoxCorrection}
            }%
            %---  End Footnote  ---%
    \end{itemize}
...
\begin{proposition}{Characterisations of Monomorphisms in $\sfRel$ \rmII}{characterisations-of-monomorphisms-in-rel-2}%
    ...
    \begin{enumerate}
        ...
        \item\label{characterisations-of-monomorphisms-in-rel-2-4}There exists an injective function $f\colon A\hookrightarrow B$ satisfying the following conditions:%
            %--- Begin Footnote ---%
            \footnote{%
                Here we are assuming the axiom of choice.
            }%
            %---  End Footnote  ---%
            \begin{enumerate}
                \item\label{characterisations-of-monomorphisms-in-rel-2-4-a}We have $\Gr(f)\subset R$.%
                    %--- Begin Footnote ---%
                    \footnote{%
                    ...
                    %---  End Footnote  ---%
                \item\label{characterisations-of-monomorphisms-in-rel-2-4-b}For each $a\in A$, we have
                    \begin{webcompile}
                        R^{-1}(f(a))%
                        =%
                        \{a\},%
                    ...
                    \end{webcompile}
            \end{enumerate}
        \item\label{characterisations-of-monomorphisms-in-rel-2-5}We have
            \begin{webcompile}
                R_{-1}\circ R_{!}%
                =%
                \id_{\mathcal{P}(A)}%
...
\begin{Proof}{Proof of \cref{characterisations-of-monomorphisms-in-rel-2}}%
    ...
    \begin{itemize}
        ...
        \item Step 4: \cref{characterisations-of-monomorphisms-in-rel-2-3}$\iff$\cref{characterisations-of-monomorphisms-in-rel-2-4}.
        \item Step 5: \cref{characterisations-of-monomorphisms-in-rel-2-2}$\iff$\cref{characterisations-of-monomorphisms-in-rel-2-5}.
    \end{itemize}
    ...
    We proceed in a few steps:
    \begin{itemize}
        \item By \cref{characterisations-of-monomorphisms-in-rel-1}, to show \cref{characterisations-of-monomorphisms-in-rel-2-1} it suffices to show that, for each $U,V\in\mathcal{P}(A)$, if $R(U)\subset R(V)$, then $U\subset V$.
    ...
    \ProofBox{Step 4: \cref{characterisations-of-monomorphisms-in-rel-2-3}$\iff$\cref{characterisations-of-monomorphisms-in-rel-2-4}}%
    We claim that \cref{characterisations-of-monomorphisms-in-rel-2-3} and \cref{characterisations-of-monomorphisms-in-rel-2-4} are equivalent:
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-2-3}$\implies$\cref{characterisations-of-monomorphisms-in-rel-2-4}: }By assumption, given $a\in A$, there exists some $b\in B$ such that $R^{-1}(b)=\{a\}$. Invoking the axiom of choice, we may pick one such $b$ for each $a\in A$, giving us our desired function $f\colon A\to B$. All the requirements listed in \cref{characterisations-of-monomorphisms-in-rel-2-4} then follow by construction.
        \item\SloganFont{\cref{characterisations-of-monomorphisms-in-rel-2-4}$\implies$\cref{characterisations-of-monomorphisms-in-rel-2-3}: }Given $a\in A$, we may pick $b=f(a)$, in which case $R^{-1}(f(a))$ will be equal to $\{a\}$ by assumption.
    \end{itemize}

    \ProofBox{Step 5: \cref{characterisations-of-monomorphisms-in-rel-2-2}$\iff$\cref{characterisations-of-monomorphisms-in-rel-2-5}}%
    We have
    \begin{align*}
    ...
    \[
        ...
        U,%
    \]%
    which holds precisely when \cref{characterisations-of-monomorphisms-in-rel-2-2} does.

    \ProofBox{Proof of the Second Half of \cref{characterisations-of-monomorphisms-in-rel-2}}%
...
\end{remark}
\begin{proposition}{Characterisations of 2-Categorical Monomorphisms in $\sfRel$}{characterisations-of-2-categorical-monomorphisms-in-rel}%
    Let $R\colon A\rightproarrow B$ be a relation. The following conditions are equivalent:
    \begin{enumerate}
        \item\label{characterisations-of-2-categorical-monomorphisms-in-rel-1}The morphism $R\colon A\rightproarrow B$ is a monomorphism in $\sfRel$.
        \item\label{characterisations-of-2-categorical-monomorphisms-in-rel-2}The morphism $R\colon A\rightproarrow B$ is representably full in $\sfbfRel$.
        \item\label{characterisations-of-2-categorical-monomorphisms-in-rel-3}The morphism $R\colon A\rightproarrow B$ is representably fully faithful in $\sfbfRel$.
        \item\label{characterisations-of-2-categorical-monomorphisms-in-rel-4}The morphism $R\colon A\rightproarrow B$ is pseudomonic in $\sfbfRel$.
        \item\label{characterisations-of-2-categorical-monomorphisms-in-rel-5}The morphism $R\colon A\rightproarrow B$ is representably essentially injective in $\sfbfRel$.
        \item\label{characterisations-of-2-categorical-monomorphisms-in-rel-6}The morphism $R\colon A\rightproarrow B$ is representably conservative in $\sfbfRel$.
    \end{enumerate}
\end{proposition}
\begin{Proof}{Proof of \cref{characterisations-of-2-categorical-monomorphisms-in-rel}}%
    We will prove this by showing:
    \begin{itemize}
        \item Step 1: \cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-5}.
        \item Step 2: \cref{characterisations-of-monomorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-monomorphisms-in-rel-1-2}.
    \end{itemize}
\end{Proof}
\subsection{2-Categorical Monomorphisms}\label{subsection-2-categorical-monomorphisms-in-rel}
In this section we characterise the 2-categorical monomorphisms in $\sfbfRel$, following \ChapterRef{\ChapterTypesOfMorphismsInBicategories, \cref{types-of-morphisms-in-bicategories:section-monomorphisms-in-bicategories}}{\cref{section-monomorphisms-in-bicategories}}.
\begin{proposition}{2-Categorical Monomorphisms in $\sfbfRel$}{2-categorical-monomorphisms-in-rel}%
    Let $R\colon A\rightproarrow B$ be a relation.
    \begin{enumerate}
        \item\label{2-categorical-monomorphisms-in-rel-representably-faithful-morphisms-in-rel}\SloganFont{Representably Faithful Morphisms in $\sfbfRel$. }Every morphism of $\sfbfRel$ is representably faithful.
        \item\label{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel}\SloganFont{Representably Full Morphisms in $\sfbfRel$. }The following conditions are equivalent:
            \begin{enumerate}
                \item\label{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-1}The morphism $R\colon A\rightproarrow B$ is representably full.
                \item\label{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-2}For each pair of relations $S,T\colon X\rightproarrows A$, the following condition is satisfied:
                    \begin{itemize}
                        \itemstar If $R\procirc S\subset R\procirc T$, then $S\subset T$.
                    \end{itemize}
                \item\label{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-3}The direct image functor
                    \[
                        R_{!}%
                        \colon%
                        (\mathcal{P}(A),\subset)%
                        ...
                        (\mathcal{P}(B),\subset)%
                    \]%
                    of \cref{properties-of-the-direct-image-function-operation-for-relations-functionality-2} of \cref{properties-of-the-direct-image-function-operation-for-relations} is full.
                \item\label{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-4}The codirect image functor
                    \[
                        R_{*}%
                        \colon%
                        (\mathcal{P}(A),\subset)%
                        ...
                        (\mathcal{P}(B),\subset)%
                    \]%
                    of \cref{properties-of-the-codirect-image-function-operation-for-relations-functionality-2} of \cref{properties-of-the-codirect-image-function-operation-for-relations} is full.
                \item\label{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-5}For each $U,V\in\mathcal{P}(A)$, if $R_{!}(U)\subset R_{!}(V)$, then $U\subset V$.
            ...
            \end{enumerate}
        \item\label{2-categorical-monomorphisms-in-rel-representably-fully-faithful-morphisms-in-rel}\SloganFont{Representably Fully Faithful Morphisms in $\sfbfRel$. }Every representably full morphism in $\sfbfRel$ is representably fully faithful.
        \item\label{2-categorical-monomorphisms-in-rel-other-types-of-2-categorical-monomorphisms-in-rel}\SloganFont{Other Types of 2-Categorical Monomorphisms in $\sfbfRel$. }The following conditions are equivalent:
            \begin{enumerate}
                \item\label{2-categorical-monomorphisms-in-rel-other-types-of-2-categorical-monomorphisms-in-rel-1}The morphism $R\colon A\rightproarrow B$ is a monomorphism in $\sfRel$.
                \item\label{2-categorical-monomorphisms-in-rel-other-types-of-2-categorical-monomorphisms-in-rel-2}The morphism $R\colon A\rightproarrow B$ is representably essentially injective.
                \item\label{2-categorical-monomorphisms-in-rel-other-types-of-2-categorical-monomorphisms-in-rel-3}The morphism $R\colon A\rightproarrow B$ is representably conservative.
                \item\label{2-categorical-monomorphisms-in-rel-other-types-of-2-categorical-monomorphisms-in-rel-4}The morphism $R\colon A\rightproarrow B$ is pseudomonic.
            \end{enumerate}
    \end{enumerate}
\end{proposition}
\begin{Proof}{Proof of \cref{2-categorical-monomorphisms-in-rel}}%
    ...
    \indent However, since $\sfbfRel$ is locally posetal, the Hom-set $\Hom_{\eRel(X,A)}(S,T)$ is either empty or a singleton. Thus, in either of these cases, the map $R_{*|S,T}$ will necessarily be injective. This shows $R_{*}$ to be faithful, and $R$ to be representably faithful.
    ...
    We claim \cref{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-1,2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-2} are equivalent. Indeed, this is simply a matter of unwinding definitions: the relation $R$ is a representably full morphism in $\sfbfRel$ \textiff, for each $X\in\Obj(\sfbfRel)$, the functor
    \[
        R_{*}%
        \colon%
        \eRel(X,A)%
        ...
        \eRel(X,B)%
    \]%
    is full. This happens \textiff the morphism
    \[
        R_{*|S,T}%
        \colon%
        \Hom_{\eRel(X,A)}(S,T)%
        ...
        \Hom_{\eRel(X,B)}(R\procirc S,R\procirc T)%
    \]%
    is surjective for each $S,T\in\Obj(\eRel(X,A))$, which in turn happens \textiff, whenever $R\procirc S\subset R\procirc T$, we also have $S\subset T$.

    \indent Next, we claim \cref{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-3,2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-5} are also equivalent. This is also simply a matter of unwinding definitions: the functor
    \[
        R_{!}%
        \colon%
        (\mathcal{P}(A),\subset)%
    ...
    \]%
    is surjective. This happens \textiff whenever $R_{!}(U)\subset R_{!}(V)$, we also necessarily have $U\subset V$.

    \indent The equivalence between \cref{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-4,2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-2} proceeds in a similar manner, and is thus omitted.

    \indent Next, we claim \cref{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-5,2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-6} are equivalent. Indeed:
    \begin{itemize}
        \item\SloganFont{\cref{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-5}$\implies$\cref{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-6}: }Suppose that the following condition is true:
            \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item By \cref{properties-of-codirect-image-functions-associated-to-relations-relation-to-direct-images} of \cref{properties-of-codirect-image-functions-associated-to-relations}, we have
                    \begin{align*}
            ...
            \end{itemize}
        \item\SloganFont{\cref{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-6}$\implies$\cref{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-5}: }Suppose that the following condition is true:
            \begin{itemize}
                \itemstar For each $U,V\in\mathcal{P}(A)$, if $R_{*}(U)\subset R_{*}(V)$, then $U\subset V$.
            \end{itemize}
            We need to show that the condition
            ...
            \begin{itemize}
                \item Suppose we have $U,V\in\mathcal{P}(A)$ with $R_{!}(U)\subset R_{!}(V)$.
                \item By \cref{properties-of-direct-image-functions-associated-to-relations-relation-to-codirect-images} of \cref{properties-of-direct-image-functions-associated-to-relations}, we have
                    \begin{align*}
                        R_{!}(U) &= B\setminus R_{*}(A\setminus U),\\
                        R_{!}(V) &= B\setminus R_{*}(A\setminus V).
                    \end{align*}
            ...
            \end{itemize}
    \end{itemize}
    \indent Finally, we claim \cref{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-2,2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-5} are equivalent. Indeed:
    \begin{itemize}
        \item\SloganFont{\cref{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-2}$\implies$\cref{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-5}: }Consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    X
                    \arrow[r, "S", shift left=0.8, mid vert]
            ...
            \]%
            for each $x\in X$, implying $S\subset T$.
        \item\SloganFont{\cref{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-5}$\implies$\cref{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-2}: }Let $U,V\in\mathcal{P}(A)$ and consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    \pt
                    \arrow[r, "U",  shift left=0.8,  mid vert]
    ...
    \ProofBox{\cref{2-categorical-monomorphisms-in-rel-other-types-of-2-categorical-monomorphisms-in-rel}: Other Types of 2-Categorical Monomorphisms in $\sfbfRel$}%
    This follows from the fact that $\sfbfRel$ is locally posetal, so $R$ will be essentially injective, conservative, or pseudomonic \textiff, whenever $R\procirc S=R\procirc T$, we also have $S=T$. This happens precisely when $R$ is a monomorphism.
\end{Proof}
