...
\begin{explanation}{Monomorphisms in $\sfRel$}{explanation-for-result-on-monomorphisms-in-rel}%
...
\begin{proposition}{Characterisations of Monomorphisms in $\sfRel$ \rmI}{characterisations-of-monomorphisms-in-rel-1}%
    ...
    \begin{enumerate}
        ...
        \item\label{characterisations-of-monomorphisms-in-rel-1-6}For each pair of relations $S,T\colon X\rightproarrows A$, the following condition is satisfied:
            ...
            \end{itemize}
        \item\label{characterisations-of-monomorphisms-in-rel-1-7}We have
            \begin{webcompile}
                R_{-1}\circ R_{!}%
                =%
                \id_{\mathcal{P}(A)}%
...
\begin{Proof}{Proof of \cref{characterisations-of-monomorphisms-in-rel-1}}%
    ...
    We will use the next proposition, \cref{characterisations-of-monomorphisms-in-rel-2}, which shows that \cref{characterisations-of-monomorphisms-in-rel-2-2} there is equivalent to \cref{characterisations-of-monomorphisms-in-rel-1-7} here. The proof of \cref{characterisations-of-monomorphisms-in-rel-2} will therefore make no reference to \cref{characterisations-of-monomorphisms-in-rel-1-7} of this proposition to avoid circular reasoning.

    \indent Indeed, we have
    \begin{align*}
    ...
    \[
        ...
        U,%
    \]%
    which holds precisely when \cref{characterisations-of-monomorphisms-in-rel-2-2} of \cref{characterisations-of-monomorphisms-in-rel-2} does. By \cref{characterisations-of-monomorphisms-in-rel-2}, that in turn holds precisely if \cref{characterisations-of-monomorphisms-in-rel-2-1} of \cref{characterisations-of-monomorphisms-in-rel-2} holds, which is the exact same condition as \cref{characterisations-of-monomorphisms-in-rel-1-1} of this proposition.
\end{Proof}
\begin{proposition}{Characterisations of Monomorphisms in $\sfRel$ \rmII}{characterisations-of-monomorphisms-in-rel-2}%
    ...
    \begin{enumerate}
        ...
        \item\label{characterisations-of-monomorphisms-in-rel-2-4}There exists an injective function $f\colon A\hookrightarrow B$ satisfying the following conditions:%
            %--- Begin Footnote ---%
            \footnote{%
                We are assuming the axiom of choice for \cref{characterisations-of-monomorphisms-in-rel-2-4}.
            }%
            %---  End Footnote  ---%
            \begin{enumerate}
