...
\begin{proposition}{Properties of Internal Right Kan Extensions in $\sfbfRel$}{properties-of-internal-right-kan-extensions-in-rel}%
    ...
    \begin{enumerate}
        ...
        \item\label{properties-of-internal-right-kan-extensions-in-rel-associativity}\SloganFont{Associativity. }We have
            \[
                (T\intcirc F)\intcirc R
                =
                T\intcirc(F\intcirc R).
            \]%
            That is, we have
            \[
                \bigcup_{b\in R(a)}\bigcup_{c\in F(b)}T(c)%
                =%
                \bigcup_{c\in\bigcup_{b\in R(a)}F(b)}T(c)%
            \]%
            for each $a\in A$.
        \item\label{properties-of-internal-right-kan-extensions-in-rel-unitality}\SloganFont{Unitality. }We have
            \begin{align*}
            ...
            \end{align*}
            for each $a\in A$.
        \item\label{properties-of-internal-right-kan-extensions-in-rel-linear-distributivity}\SloganFont{Linear Distributivity. }We have inclusions of relations
            \begin{align*}
        ...
        \item\label{properties-of-internal-right-kan-extensions-in-rel-interaction-with-converses}\SloganFont{Interaction With Converses. }We have
            ...
            \]%
        \item\label{properties-of-internal-right-kan-extensions-in-rel-interaction-with-ranges-and-domains}\SloganFont{Interaction With Ranges and Domains. }We have
            \begin{align*}
...
\begin{Proof}{Proof of \cref{properties-of-internal-right-kan-extensions-in-rel}}%
    ...
    \ProofBox{\cref{properties-of-internal-right-kan-extensions-in-rel-oplax-associativity}: Oplax Associativity}%
    ...
    \ProofBox{\cref{properties-of-internal-right-kan-extensions-in-rel-unitality}: Unitality}%
    Indeed, we have
    \begin{align*}
    ...
    \ProofBox{\cref{properties-of-internal-right-kan-extensions-in-rel-linear-distributivity}: Linear Distributivity}%
    This is a repetition of \cref{properties-of-apartness-composition-of-relations-linear-distributivity} of \cref{properties-of-apartness-composition-of-relations} and is proved there.

    \ProofBox{\cref{properties-of-internal-right-kan-extensions-in-rel-interaction-with-converses}: Interaction With Converses}%
    This is a repetition of \cref{properties-of-converses-of-relations-interaction-with-composition} of \cref{properties-of-converses-of-relations} and is proved there.

    \ProofBox{\cref{properties-of-internal-right-kan-extensions-in-rel-interaction-with-ranges-and-domains}: Interaction With Ranges and Domains}%
    We have
    \begin{align*}
