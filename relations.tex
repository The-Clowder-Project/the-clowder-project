...
\begin{example}{Partial Functions}{examples-of-relations-partial-functions}%
    Partial functions may be viewed (or defined) as being exactly those relations which are functional (\ChapterRef{\ChapterConditionsOnRelations, \cref{conditions-on-relations:subsection-functional-relations}}{\cref{subsection-functional-relations}}).
\end{example}
