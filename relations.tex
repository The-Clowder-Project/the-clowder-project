...
\begin{Proof}{Proof of \cref{natural-conditions-that-fail-to-characterise-monomorphisms-in-rel}}%
    ...
    Let $A=\{a_{1},a_{2},a_{3}\}$, $B=\{b_{1},b_{2}\}$, and let $R\colon A\rightproarrow B$ be the relation defined by
    \begin{align*}
        R(a_{1}) &= \{b_{1}\},\\
        R(a_{2}) &= \{b_{2}\},\\
        R(a_{3}) &= \{b_{1},b_{2}\}.
    ...
    However, taking $U=\{a_{1},a_{2}\}$ and $V=\{a_{3}\}$ shows that $R(U)=R(V)$ holds while $U\neq V$.
\end{Proof}
