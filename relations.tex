...
\begin{definition}{Relations}{relations}%
    ...
    %--- Begin Footnote ---%
    \footnote{%
        \SloganFont{Further Terminology: }Also called a \textbf{multivalued function from $A$ to $B$}, a \textbf{relation over $A$ and $B$}, \textbf{relation on $A$ and $B$}, a \textbf{binary relation over $A$ and $B$}, or a \textbf{binary relation on $A$ and $B$}.
    }%
    %---  End Footnote  ---%
    %--- Begin Footnote ---%
    \footnote{%
...
\begin{notation}{Further Notation for Relations}{further-notation-for-relations}%
    ...
    \end{enumerate}
\end{notation}
\begin{definition}{The Po/Set of Relations Over Two Sets}{the-po-set-of-relations-over-two-sets}%
    Let $A$ and $B$ be sets.
    \begin{enumerate}
        \item\label{the-po-set-of-relations-over-two-sets-1}The \index[set-theory]{relation!set of}\textbf{set of relations from $A$ to $B$} is the set \index[notation]{RelAB@$\Rel(A,B)$}$\Rel(A,B)$ defined by
            \[
                \Rel(A,B)
                \defeq
                \{%
                ...
                \}.%
            \]%
        \item\label{the-po-set-of-relations-over-two-sets-2}The \index[set-theory]{relation!poset of}\textbf{poset of relations from $A$ to $B$} is the poset \index[notation]{RelAB@$\eRel(A,B)$}%
            \[
                \eRel(A,B)%
                \defeq%
                (\Rel(A,B),\subset)%
            ...
            consisting of:
            \begin{itemize}
                \item\SloganFont{The Underlying Set. }The set $\Rel(A,B)$ of \cref{the-po-set-of-relations-over-two-sets-1}.
            ...
            \end{itemize}
        \item\label{the-po-set-of-relations-over-two-sets-3}The \index[set-theory]{relation!category of}\textbf{category of relations from $A$ to $B$} is the posetal category \index[notation]{RelAB@$\eRel(A,B)$}$\eRel(A,B)$%
            %--- Begin Footnote ---%
            \footnote{%
            ...
            %---  End Footnote  ---%
            associated to the poset $\eRel(A,B)$ of \cref{the-po-set-of-relations-over-two-sets-2} via \ChapterRef{\ChapterCategories, \cref{categories:posetal-categories}}{\cref{posetal-categories}}.%
    \end{enumerate}
\end{definition}
\begin{remark}{Equivalent Definitions of Relations}{equivalent-definitions-of-relations}%
    A relation from $A$ to $B$ is equivalently:%
    %--- Begin Footnote ---%
    \footnote{%
        \SloganFont{Intuition: }In particular, we may think of a relation $R\colon A\to\mathcal{P}(B)$ from $A$ to $B$ as a multivalued function from $A$ to $B$ (including the possibility of a given $a\in A$ having no value at all).
        \par\vspace*{-1.75\baselineskip}
    }%
    %---  End Footnote  ---%
    \begin{enumerate}
...
\end{remark}
\begin{Proof}{Proof of \cref{equivalent-definitions-of-relations}}%
    We claim that \cref{equivalent-definitions-of-relations-item-1,equivalent-definitions-of-relations-item-2,equivalent-definitions-of-relations-item-3,equivalent-definitions-of-relations-item-4,equivalent-definitions-of-relations-item-5} are indeed equivalent:
    \begin{itemize}
        \item\SloganFont{\cref{equivalent-definitions-of-relations-item-1}$\iff$\cref{equivalent-definitions-of-relations-item-2}: }This is a special case of \ChapterRef{\ChapterConstructionsWithSets, \cref{constructions-with-sets:properties-of-powersets-as-sets-of-functions-relations-powersets-as-sets-of-functions-1,constructions-with-sets:properties-of-powersets-as-sets-of-functions-relations-powersets-as-sets-of-functions-2} of \cref{constructions-with-sets:properties-of-powersets-as-sets-of-functions-relations}}{\cref{properties-of-powersets-as-sets-of-functions-relations-powersets-as-sets-of-functions-1,properties-of-powersets-as-sets-of-functions-relations-powersets-as-sets-of-functions-2} of \cref{properties-of-powersets-as-sets-of-functions-relations}}.
        \item\SloganFont{\cref{equivalent-definitions-of-relations-item-2}$\iff$\cref{equivalent-definitions-of-relations-item-3}: }This follows from the bijections
            \begin{align*}
                \Hom_{\Sets}(A\times B,\TV) &\cong \Hom_{\Sets}(A,\Hom_{\Sets}(B,\TV))\\
                                            &\cong \Hom_{\Sets}(A,\mathcal{P}(B)),
            \end{align*}
            where the last bijection is from \ChapterRef{\ChapterConstructionsWithSets, \cref{constructions-with-sets:properties-of-powersets-as-sets-of-functions-relations-powersets-as-sets-of-functions-1,constructions-with-sets:properties-of-powersets-as-sets-of-functions-relations-powersets-as-sets-of-functions-2} of \cref{constructions-with-sets:properties-of-powersets-as-sets-of-functions-relations}}{\cref{properties-of-powersets-as-sets-of-functions-relations-powersets-as-sets-of-functions-1,properties-of-powersets-as-sets-of-functions-relations-powersets-as-sets-of-functions-2} of \cref{properties-of-powersets-as-sets-of-functions-relations}}.
        \item\SloganFont{\cref{equivalent-definitions-of-relations-item-2}$\iff$\cref{equivalent-definitions-of-relations-item-4}: }This follows from the bijections
            \begin{align*}
                \Hom_{\Sets}(A\times B,\TV) &\cong \Hom_{\Sets}(B,\Hom_{\Sets}(B,\TV))\\
                                            &\cong \Hom_{\Sets}(B,\mathcal{P}(A)),
            \end{align*}
            where again the last bijection is from \ChapterRef{\ChapterConstructionsWithSets, \cref{constructions-with-sets:properties-of-powersets-as-sets-of-functions-relations-powersets-as-sets-of-functions-1,constructions-with-sets:properties-of-powersets-as-sets-of-functions-relations-powersets-as-sets-of-functions-2} of \cref{constructions-with-sets:properties-of-powersets-as-sets-of-functions-relations}}{\cref{properties-of-powersets-as-sets-of-functions-relations-powersets-as-sets-of-functions-1,properties-of-powersets-as-sets-of-functions-relations-powersets-as-sets-of-functions-2} of \cref{properties-of-powersets-as-sets-of-functions-relations}}.
        \item\SloganFont{\cref{equivalent-definitions-of-relations-item-2}$\iff$\cref{equivalent-definitions-of-relations-item-5}: }This follows from the universal property of the powerset $\mathcal{P}(X)$ of a set $X$ as the free cocompletion of $X$ via the characteristic embedding
            \[
                \chi_{X}
                \colon
                X
                ...
                \mathcal{P}(X)
            \]%
            of $X$ into $\mathcal{P}(X)$, \ChapterRef{\ChapterConstructionsWithSets, \cref{constructions-with-sets:properties-of-powersets-as-free-cocompletions-adjointness} of \cref{constructions-with-sets:properties-of-powersets-as-free-cocompletions}}{\cref{properties-of-powersets-as-free-cocompletions-adjointness} of \cref{properties-of-powersets-as-free-cocompletions}}.
            % BEGIN RAW HTML %
            <br>
            % BEGIN LATEX HTML %
            ...
            \]%
            is given by taking a relation $R\colon A\rightproarrow B$, passing to its associated function $f\colon A\to\mathcal{P}(B)$ from $A$ to $B$ and then extending $f$ from $A$ to all of $\mathcal{P}(A)$ by taking its left Kan extension along $\chi_{X}$.
            % BEGIN RAW HTML %
            <br>
            % BEGIN LATEX HTML %

            % END RAW HTML %
            This coincides with the direct image function $f_{*}\colon\mathcal{P}(A)\to\mathcal{P}(B)$ of \ChapterRef{\ChapterConstructionsWithSets, \cref{constructions-with-sets:the-direct-image-function-associated-to-a-function}}{\cref{the-direct-image-function-associated-to-a-function}}.
    \end{itemize}
            ...
            \begin{itemize}
                \item The powerset $\mathcal{P}(X)$ of a set $X$ as the free cocompletion of $X$ via the characteristic embedding
                    \[
                        ...
                        \mathcal{P}(X)
                    \]%
                    of $X$ into $\mathcal{P}(X)$, as stated and proved in \ChapterRef{\ChapterConstructionsWithSets, \cref{constructions-with-sets:properties-of-powersets-as-free-cocompletions-adjointness} of \cref{constructions-with-sets:properties-of-powersets-as-free-cocompletions}}{\cref{properties-of-powersets-as-free-cocompletions-adjointness} of \cref{properties-of-powersets-as-free-cocompletions}}.
...
\begin{example}{The Characteristic Relation of a Set}{the-characteristic-relation}%
    ...
    \[%
        ...
        \TTV%
    \]%
    on $X$ of \ChapterRef{\ChapterConstructionsWithSets, \cref{constructions-with-sets:characteristic-functions-characteristic-relation} of \cref{constructions-with-sets:characteristic-functions}}{\cref{characteristic-functions-characteristic-relation} of \cref{characteristic-functions}}, defined by%
    \[
        \chi_{X}(x,y)
        \defeq
        \begin{cases}
    ...
    \begin{itemize}
        \item\SloganFont{Action on Objects. }For each $A,B\in\Obj(\sfRel)$, we have%
            \[%
                ...
                A\times B,%
            \]%
            where $A\times B$ is the Cartesian product of sets of \ChapterRef{\ChapterConstructionsWithSets, \cref{constructions-with-sets:products-of-sets}}{\cref{products-of-sets}}.
    ...
    \begin{itemize}
        ...
        \item\SloganFont{Action on Morphisms. }For each vertical morphism $f\colon A\to B$ of $\dblRel$, i.e.\ each map of sets $f$ from $A$ to $B$, the identity $2$-morphism
            ...
            \begin{webcompile}
                ...
                \end{tikzcd}
            \end{webcompile}%
            of \ChapterRef{\ChapterConstructionsWithSets, \cref{constructions-with-sets:properties-of-characteristic-functions-the-inclusion-of-characteristic-relations-associated-to-a-function} of \cref{constructions-with-sets:properties-of-characteristic-functions}}{\cref{properties-of-characteristic-functions-the-inclusion-of-characteristic-relations-associated-to-a-function} of \cref{properties-of-characteristic-functions}}.
...
\begin{Proof}{Proof of \cref{adjunctions-in-rel}}%
    ...
    \begin{enumerate}% PROCESS %
        \item\SloganFont{From Adjunctions in $\sfbfRel$ to Functions. }An adjunction in $\sfbfRel$ from $A$ to $B$ consists of a pair of relations
            ...
            \begin{enumerate}% PROCESS %
                \item\SloganFont{$R(a)$ Has an Element. }Given $a\in A$, since $\chi_{A}\subset S\procirc R$, we must have $\{a\}\subset S(R(a))$, implying that there exists some $b\in B$ such that $a\sim_{R}b$ and $b\sim_{S}a$, and thus $R(a)\neq\emptyset$, as $b\in R(a)$.
...
\end{Proof}
\subsection{2-Categorical Monomorphisms in $\sfbfRel$}\label{subsection-2-categorical-monomorphism-in-rel}
...
\begin{proposition}{2-Categorical Monomorphisms in $\sfbfRel$}{2-categorical-monomorphisms-in-rel}%
    ...
    \begin{enumerate}
        ...
        \item\label{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel}\SloganFont{Representably Full Morphisms in $\sfbfRel$. }The following conditions are equivalent:
            ...
            \end{enumerate}
        \item\label{2-categorical-monomorphisms-in-rel-representably-fully-faithful-morphisms-in-rel}\SloganFont{Representably Fully Faithful Morphisms in $\sfbfRel$. }Every representaly full morphism in $\sfbfRel$ is a representably fully faithful morphism.
    \end{enumerate}
\end{proposition}
\begin{Proof}{Proof of \cref{2-categorical-monomorphisms-in-rel}}%
    ...
    \ProofBox{\cref{2-categorical-monomorphisms-in-rel-fully-representably-faithful-morphisms-in-rel}: Fully Faithful Monomorphisms in $\sfbfRel$}%
...
\begin{proposition}{The Left $J$-Skew Monoidal Structure on $\eRel(A,B)$}{the-left-j-skew-monoidal-structure-on-erelab}%
    ...
    \begin{itemize}
        \item\SloganFont{The Underlying Category. }The posetal category associated to the poset $\eRel(A,B)$ of relations from $A$ to $B$ of \cref{the-po-set-of-relations-over-two-sets-2} of \cref{the-po-set-of-relations-over-two-sets}.
