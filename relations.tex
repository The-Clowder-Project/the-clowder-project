...
\begin{enumerate}
    ...
    \item\label{relations-introduction-item-5}The adjoint pairs% TODO: FIX LABEL NUMBERING
        ...
        \begin{enumerate}
            ...
            \item\label{relations-introduction-item-5b}We have $R_{-1}=R^{-1}$ \textiff $R$ is total and functional (\cref{properties-of-strong-inverse-image-functions-associated-to-relations-interaction-with-weak-inverse-images-2} of \cref{properties-of-strong-inverse-image-functions-associated-to-relations}).
    ...
    \begin{webcompile}
        ...
        \begin{tikzcd}[row sep={3.0*\the\DL,between origins}, column sep={8.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&,%
                execute at end picture={%
                    % A
                    \draw (\tikzcdmatrixname-4-1) [partial ellipse=3:34:{1.5*\the\DL} and {5.0*\the\DL}];
                    \draw (\tikzcdmatrixname-4-1) [partial ellipse=40.5:43.5:{1.5*\the\DL} and {5.0*\the\DL}];
                    \draw (\tikzcdmatrixname-4-1) [partial ellipse=59:318:{1.5*\the\DL} and {5.0*\the\DL}];
                    \draw (\tikzcdmatrixname-4-1) [partial ellipse=327:357:{1.5*\the\DL} and {5.0*\the\DL}];
                    % B
                    \draw (\tikzcdmatrixname-3-2) [partial ellipse=0:161:{2.0*\the\DL} and {8.0*\the\DL}];
                    \draw (\tikzcdmatrixname-3-2) [partial ellipse=165:178:{2.0*\the\DL} and {8.0*\the\DL}];
                    \draw (\tikzcdmatrixname-3-2) [partial ellipse=182:200:{2.0*\the\DL} and {8.0*\the\DL}];
                    \draw (\tikzcdmatrixname-3-2) [partial ellipse=204:225:{2.0*\the\DL} and {8.0*\the\DL}];
                    \draw (\tikzcdmatrixname-3-2) [partial ellipse=232:360:{2.0*\the\DL} and {8.0*\the\DL}];
                    % (3)
    ...
    \begin{itemize}
        ...
        \item\SloganFont{If $R$ Is Total and ($\star$) Holds, Then $R$ Is a Monomorphism: }Consider the diagram
            \[
                ...
                \end{tikzcd}
            \]%
            and let $x\in X$ and $a\in A$ such that $x\sim_{S}a$.
            \begin{itemize}
                ...
                \item However, since $a\sim_{R}b$ and $a'\sim_{R}b$, we must have $a=a'$.
...
\begin{explanation}{Epimorphisms in $\sfRel$}{explanation-epimorphisms-in-rel}%
    ...
    \begin{itemize}
        ...
        \item \cref{characterisations-of-2-categorical-epimorphisms-in-rel-1,characterisations-of-2-categorical-epimorphisms-in-rel-2} characterise the 2-categorical epimorphisms in $\sfbfRel$.%
            ...
            %---  End Footnote  ---%
    \end{itemize}
    Essentially, a epimorphism $R\colon A\rightproarrow B$ in $\sfRel$ will look like this:
    \begin{webcompile}
        \mkern25mu
        \begin{tikzcd}[row sep={3.0*\the\DL,between origins}, column sep={8.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&,%
                execute at end picture={%
    ...
    That is:
    \begin{enumerate}
        \item\label{explanation-for-result-on-epimorphisms-in-rel-1}$R$ should contain an injection $f\colon A\hookrightarrow B$ embedding a copy of $A$ into $B$.
        \item\label{explanation-for-result-on-epimorphisms-in-rel-2}$R$ can be non-functional, mapping elements of $A$ into multiple elements of $B$ (but not to more than one in $\Im(f)$).
        \item\label{explanation-for-result-on-epimorphisms-in-rel-3}$R$ doesn't need to be surjective, so $B$ can have elements that aren't in the image of $R$.
    \end{enumerate}
\end{explanation}
\begin{proposition}{Characterisations of Epimorphisms in $\sfRel$ \rmI}{characterisations-of-epimorphisms-in-rel-1}%
    ...
    %---  End Footnote  ---%
    \begin{enumerate}
        \item\label{characterisations-of-epimorphisms-in-rel-1-1}The relation $R$ is a epimorphism in $\sfRel$.
        \item\label{characterisations-of-epimorphisms-in-rel-1-2}The direct image function%
            ...
            \]%
            associated to $R$ is injective.
        \item\label{characterisations-of-epimorphisms-in-rel-1-3}The codirect image function
            \[
                R_{-1}%
                \colon%
                \mathcal{P}(B)%
            ...
            \]%
            associated to $R$ is injective.
        \item\label{characterisations-of-epimorphisms-in-rel-1-4}The direct image functor
            \[
                R^{-1}%
                \colon%
                (\mathcal{P}(B),\subset)%
            ...
            \]%
            associated to $R$ is full.
        \item\label{characterisations-of-epimorphisms-in-rel-1-5}The codirect image functor
            \[
                R_{-1}%
                \colon%
                (\mathcal{P}(B),\subset)%
...
\begin{Proof}{Proof of \cref{characterisations-of-epimorphisms-in-rel-1}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1-1}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1-2}: }Let $U,V\in\mathcal{P}(A)$ and consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    \pt
                    \arrow[r, "U", shift left=0.8,   mid vert]
            ...
            \begin{align*}
                ...
                R^{-1}(V) &= R\procirc V.
            \end{align*}
            Now, if $R\procirc U=R\procirc V$, i.e.\ $R^{-1}(U)=R^{-1}(V)$, then $U=V$ since $R$ is assumed to be a epimorphism, showing $R^{-1}$ to be injective.
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1-2}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1-1}: }Conversely, suppose that $R^{-1}$ is injective, consider the diagram
            \[
                ...
                \end{tikzcd}
            \]%
            and suppose that $R\procirc S=R\procirc T$. Note that, since $R^{-1}$ is injective, given a diagram of the form
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    \pt
                    \arrow[r, "U", shift left=0.8,   mid vert]
                ...
                \end{tikzcd}
            \]%
            if $R^{-1}(U)=R\procirc U=R\procirc V=R^{-1}(V)$, then $U=V$. In particular, for each $x\in X$, we may consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    \pt
                    \arrow[r, "{[x]}", shift left=0.8, mid vert]
            ...
            \[
                ...
                T(x)
            \]%
            for each $x\in X$. Thus $S=T$ and $R$ is a epimorphism.
    \end{itemize}
    ...
    A more abstract proof can also be given, following \cite{MSE350788}:
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1}$\implies$\cref{characterisations-of-epimorphisms-in-rel-2}: }Assume that $R$ is a epimorphism.
            \begin{itemize}
                \item We first notice that the functor $\Rel(\pt,-)\colon\Rel\to\Sets$ maps $R$ to $R^{-1}$ by \cref{unwinding-the-direct-image-function-associated-to-a-relation}.
                ...
                \item Since $R$ is a epimorphism and $\Rel(\pt,-)$ maps $R$ to $R^{-1}$, it follows that $R^{-1}$ is also a epimorphism.
        ...
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-2}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1}: }Assume that $R^{-1}$ is injective.
            \begin{itemize}
                \item We first notice that the functor $\Rel(\pt,-)\colon\Rel\to\Sets$ maps $R$ to $R^{-1}$ by \cref{unwinding-the-direct-image-function-associated-to-a-relation}.
                \item Since the epimorphisms in $\Sets$ are precisely the injections (\ChapterRef{\ChapterTypesOfMorphismsInCategories, \cref{types-of-morphisms-in-categories:examples-of-epimorphisms-epimorphisms-in-sets} of \cref{types-of-morphisms-in-categories:examples-of-epimorphisms}}{\cref{examples-of-epimorphisms-epimorphisms-in-sets} of \cref{examples-of-epimorphisms}}), it follows that $R^{-1}$ is a epimorphism.
                ...
                \item Since $R^{-1}$ is a epimorphism and $\Rel(\pt,-)$ maps $R$ to $R^{-1}$, it follows that $R$ is also a epimorphism.
            \end{itemize}
    \end{itemize}
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1-2}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1-4}: }We proceed in a few steps:
            \begin{itemize}
                \item Let $U,V\in\mathcal{P}(A)$ such that $R^{-1}(U)\subset R^{-1}(V)$, assume $R^{-1}$ to be injective, and consider the set $U\cup V$.
                \item Since $R^{-1}(U)\subset R^{-1}(V)$, we have
                    \begin{align*}
                        R^{-1}(U\cup V) &= R^{-1}(U)\cup R^{-1}(V)\\
                        &= R^{-1}(V),
                    \end{align*}
                    where we have used \cref{properties-of-direct-image-functions-associated-to-relations-symmetric-strict-epiidality-with-respect-to-unions} of \cref{properties-of-direct-image-functions-associated-to-relations} for the first equality.
                \item Since $R^{-1}$ is injective, this implies $U\cup V=V$.
                \item Thus $U\subset V$, as we wished to show.
            \end{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1-2}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1-4}: }We proceed in a few steps:
            \begin{itemize}
                \item Suppose \cref{characterisations-of-epimorphisms-in-rel-1-4} holds, and let $U,V\in\mathcal{P}(A)$ such that $R^{-1}(U)=R^{-1}(V)$.
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1-4}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1-6}: }Let $U,V\in\mathcal{P}(A)$ and consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    \pt
                    \arrow[r, "U",  shift left=0.8,  mid vert]
            ...
            \begin{align*}
                ...
                R^{-1}(V) &= R\procirc V.
            \end{align*}
            Now, if $R\procirc U\subset R\procirc V$, then $R^{-1}(U)\subset R^{-1}(V)$. By assumption, we then have $U\subset V$.
...
\begin{proposition}{Characterisations of Epimorphisms in $\sfRel$ \rmII}{characterisations-of-epimorphisms-in-rel-2}%
    Let $R\colon A\rightproarrow B$ be a relation. The following conditions are equivalent:%
    \begin{enumerate}
        \item\label{characterisations-of-epimorphisms-in-rel-2-1}The relation $R$ is a epimorphism in $\sfRel$.
        \item\label{characterisations-of-epimorphisms-in-rel-2-2}For each $a\in A$ and each $U\in\mathcal{P}(A)$, if $R(a)\subset R(U)$, then $a\in U$.
        \item\label{characterisations-of-epimorphisms-in-rel-2-3}For each $a\in A$, there exists some $b\in B$ such that $R^{-1}(b)=\{a\}$.
    \end{enumerate}
    Moreover, if $R$ is a epimorphism, then it satisfies the following condition, and the converse holds if $R$ is total:
    \begin{itemize}
        \itemstar For each $a,a'\in A$, if there exists some $b\in B$ such that $a\sim_{R}b$ and $a'\sim_{R}b$, then $a=a'$.
    \end{itemize}
\end{proposition}
\begin{Proof}{Proof of \cref{characterisations-of-epimorphisms-in-rel-2}}%
    ...
    We proceed in a few steps:
    \begin{itemize}
        \item If $R$ is a epimorphism, then, by \cref{characterisations-of-epimorphisms-in-rel-1-2} of \cref{characterisations-of-epimorphisms-in-rel-1}, the functor
            \[
                R^{-1}%
                \colon%
                (\mathcal{P}(A),\subset)%
    ...
    We proceed in a few steps:
    \begin{itemize}
        \item By the equivalence between \cref{characterisations-of-epimorphisms-in-rel-1-1,characterisations-of-epimorphisms-in-rel-1-4} of \cref{characterisations-of-epimorphisms-in-rel-1}, to show that $R$ is a epimorphism it suffices to prove that, for each $U,V\in\mathcal{P}(A)$, if $R(U)\subset R(V)$, then $U\subset V$.
        \item So let $u\in U$ and assume $R(U)\subset R(V)$.
        \item By assumption, there exists some $b\in B$ with $R^{-1}(b)=\{u\}$.
        \item In particular, $b\in R(U)$.
        \item Since $R(U)\subset R(V)$, we also have $b\in R(V)$.
    ...
    We claim that $R$ being a epimorphism implies condition ($\star$), and the converse holds if $R$ is total:
    \begin{itemize}
        \item\SloganFont{If $R$ Is a Epimorphism, Then ($\star$) Holds: }Let $a,a'\in A$ such that $a\sim_{R}b$ and $a'\sim_{R}b$ for some $b\in B$ and consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    \pt
                    \arrow[r, "{[a]}",   shift left=0.8, mid vert]
            ...
            \begin{itemize}
                ...
                \item Similarly, $\star\sim_{R\procirc[a']}b$.
                \item Thus $R\procirc[a]=R\procirc[a']$.
                \item Since $R$ is a epimorphism, we have $[a]=[a']$, so $a=a'$.
            \end{itemize}
        \item\SloganFont{If $R$ Is Total and ($\star$) Holds, Then $R$ Is a Epimorphism: }Consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    X
                    \arrow[r, "S",  shift left=0.8,  mid vert]
            ...
            \begin{itemize}
                ...
                \item Thus $x\sim_{T}a$ as well.
                \item A similar argument shows that if $x\sim_{T}a$, then $x\sim_{S}a$.
                \item Thus $S=T$, showing $R$ to be a epimorphism.
            \end{itemize}
    \end{itemize}
    This finishes the proof.
\end{Proof}
...
\begin{proposition}{Characterisations of 2-Categorical Epimorphisms in $\sfbfRel$ \rmII}{characterisations-of-2-categorical-epimorphisms-in-rel-2}%
    Let $R\colon A\rightproarrow B$ be a relation. The following conditions are equivalent:
    \begin{enumerate}
        \item\label{characterisations-of-2-categorical-epimorphisms-in-rel-2-1}The morphism $R\colon A\rightproarrow B$ is a epimorphism in $\sfRel$.
...
\begin{Proof}{Proof of \cref{characterisations-of-epimorphisms-in-rel}}%
    ...
    Firstly note that \cref{characterisations-of-epimorphisms-in-rel-2,characterisations-of-epimorphisms-in-rel-3} are equivalent by \cref{properties-of-strong-inverse-image-functions-associated-to-relations-interaction-with-weak-inverse-images-1} of \cref{properties-of-strong-inverse-image-functions-associated-to-relations}. We then claim that \cref{characterisations-of-epimorphisms-in-rel-1,characterisations-of-epimorphisms-in-rel-2} are also equivalent:
    \begin{itemize}
    ...
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1}$\implies$\cref{characterisations-of-epimorphisms-in-rel-2}: }Assume that $R$ is an epimorphism.
            \begin{itemize}
                ...
                \item Since $R$ is an epimorphism and $\Rel(-,\pt)$ maps $R$ to $R^{-1}$, it follows that $R^{-1}$ is a epimorphism.
                \item Since the epimorphisms in $\Sets$ are precisely the injections (\ChapterRef{\ChapterTypesOfMorphismsInCategories, \cref{types-of-morphisms-in-categories:examples-of-epimorphisms-epimorphisms-in-sets} of \cref{types-of-morphisms-in-categories:examples-of-epimorphisms}}{\cref{examples-of-epimorphisms-epimorphisms-in-sets} of \cref{examples-of-epimorphisms}}), it follows that $R^{-1}$ is injective.
            \end{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-2}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1}: }Assume that $R^{-1}$ is injective.
            \begin{itemize}
                ...
                \item The epimorphisms $\Rel^{\op}$ are precisely the epimorphisms in $\Rel$ by \ChapterRef{\ChapterTypesOfMorphismsInCategories, \cref{types-of-morphisms-in-categories:properties-of-epimorphisms-duality} of \cref{types-of-morphisms-in-categories:properties-of-epimorphisms}}{\cref{properties-of-epimorphisms-duality} of \cref{properties-of-epimorphisms}}.
                \item Since $R^{-1}$ is a epimorphism and $\Rel(-,\pt)$ maps $R$ to $R^{-1}$, it follows that $R$ is an epimorphism.
            \end{itemize}
    \end{itemize}
