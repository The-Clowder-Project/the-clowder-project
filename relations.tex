...
\begin{explanation}{Monomorphisms in $\sfRel$}{explanation-monomorphisms-in-rel}%
    ...
    \begin{itemize}
        ...
        \item \cref{characterisations-of-2-categorical-monomorphisms-in-rel-1,characterisations-of-2-categorical-monomorphisms-in-rel-2} characterise the 2-categorical monomorphisms in $\sfbfRel$.%
            ...
            %---  End Footnote  ---%
    \end{itemize}
    Essentially, a monomorphism $R\colon A\rightproarrow B$ in $\sfRel$ will look like this:
    \begin{webcompile}
        \mkern25mu
        \begin{tikzcd}[row sep={3.0*\the\DL,between origins}, column sep={8.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&,%
                execute at end picture={%
                    % A
                    \draw (\tikzcdmatrixname-4-1) [partial ellipse=3:34:{2.0*\the\DL} and {5.0*\the\DL}];
                    \draw (\tikzcdmatrixname-4-1) [partial ellipse=40.5:43.5:{2.0*\the\DL} and {5.0*\the\DL}];
                    \draw (\tikzcdmatrixname-4-1) [partial ellipse=59:318:{2.0*\the\DL} and {5.0*\the\DL}];
                    \draw (\tikzcdmatrixname-4-1) [partial ellipse=327:357:{2.0*\the\DL} and {5.0*\the\DL}];
                    % B
                    \draw (\tikzcdmatrixname-3-2) [partial ellipse=0:161:{2.5*\the\DL} and {8.0*\the\DL}];
                    \draw (\tikzcdmatrixname-3-2) [partial ellipse=165:178:{2.5*\the\DL} and {8.0*\the\DL}];
                    \draw (\tikzcdmatrixname-3-2) [partial ellipse=182:200:{2.5*\the\DL} and {8.0*\the\DL}];
                    \draw (\tikzcdmatrixname-3-2) [partial ellipse=204:225:{2.5*\the\DL} and {8.0*\the\DL}];
                    \draw (\tikzcdmatrixname-3-2) [partial ellipse=232:360:{2.5*\the\DL} and {8.0*\the\DL}];
                    % (3)
                    \node at (\tikzcdmatrixname-1-2.east) {$\mkern75mu\scriptstyle(3)$};%
                }%
            ]%
            \&
            \bullet
            ...
            \arrow[from=5-1,to=5-2,mapsto,"(1)"'sloped]%
            %
            \arrow[from=3-1,to=2-2,start anchor={[xshift=-0.05*\the\DL,yshift=0.5*\the\DL]},mapsto,"(2)"sloped]%
            %
    ...
    That is:
    \begin{enumerate}
        \item\label{explanation-for-result-on-monomorphisms-in-rel-1}$R$ should contain an injection $f\colon A\hookrightarrow B$ embedding a copy of $A$ into $B$.
        \item\label{explanation-for-result-on-monomorphisms-in-rel-2}$R$ can be non-functional, mapping elements of $A$ into multiple elements of $B$ (but not to more than one in $\Im(f)$).
        \item\label{explanation-for-result-on-monomorphisms-in-rel-3}$R$ doesn't need to be surjective, so $B$ can have elements that aren't in the image of $R$.
    \end{enumerate}
\end{explanation}
        ...
        \item\label{characterisations-of-monomorphisms-in-rel-1-7}There exists an injective function $f\colon A\hookrightarrow B$ satisfying the following conditions:%
            ...
            \begin{enumerate}
                ...
                \item\label{characterisations-of-monomorphisms-in-rel-1-7-b}The diagram
                    ...
                    %---  End Footnote  ---%
            \end{enumerate}
        \item\label{characterisations-of-monomorphisms-in-rel-1-8}We have
            \begin{webcompile}
                R_{-1}\circ R_{!}%
                =%
                \id_{\mathcal{P}(A)}%
...
\begin{Proof}{Proof of \cref{characterisations-of-monomorphisms-in-rel-1}}%
    ...
    \ProofBox{Warning For Steps 5 and 6}%
    Originally, Steps 5 and 6 of this proof appeared at the end of the proof of the next proposition (\cref{characterisations-of-monomorphisms-in-rel-2}). We will use it for steps 5 and 6, but do note that the proof of the next proposition does not make reference to \cref{characterisations-of-monomorphisms-in-rel-1-7,characterisations-of-monomorphisms-in-rel-1-8} of this proposition, avoiding circular reasoning. If you're checking this proof, please skip the next two steps, read the proof of \cref{characterisations-of-monomorphisms-in-rel-2}, and only then come back to this point.
    ...
    \end{align*}
    for each $a\in A$. As a result, the condition $R_{-1}\circ R_{!}=\id_{\mathcal{P}(A)}$ becomes
    \[
...
\begin{proposition}{Characterisations of Monomorphisms in $\sfRel$ \rmII}{characterisations-of-monomorphisms-in-rel-2}%
    ...
    \begin{itemize}
        \itemstar For each $a,a'\in A$, if there exists some $b\in B$ such that $a\sim_{R}b$ and $a'\sim_{R}b$, then $a=a'$.
    \end{itemize}
\end{proposition}
\begin{Proof}{Proof of \cref{characterisations-of-monomorphisms-in-rel-2}}%
    ...
    \begin{itemize}
        ...
        \item Step 4: The second half of the statement of this proposition.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Since $a\nin U$, we have $R(a)\nin R(U)$ by the contrapositve of \cref{characterisations-of-monomorphisms-in-rel-2-2}.
        \item As a result, there must exist some $b\in R(a)$ with $b\nin R(U)$.
        \item In particular, we have $a\in R^{-1}(b)$.
        \item Moreover, the condition $b\nin R(U)=R(A\setminus\{a\})$ means that, if $a'\in R(A\setminus\{a\})$, then $a'\nin R^{-1}(b)$.
        \item Thus $R^{-1}(b)=\{a\}$.
    \end{itemize}
    ...
    \ProofBox{Step 4: Proof of the Second Half of \cref{characterisations-of-monomorphisms-in-rel-2}}%
    We claim that $R$ being a monomorphism implies condition ($\star$), and the converse holds if $R$ is total:
    \begin{itemize}
        \item\SloganFont{If $R$ Is a Monomorphism, Then ($\star$) Holds: }Let $a,a'\in A$ such that $a\sim_{R}b$ and $a'\sim_{R}b$ for some $b\in B$ and consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    \pt
            ...
            \end{itemize}
        \item\SloganFont{If $R$ Is Total and ($\star$) Holds, Then $R$ Is a Monomorphism: }Consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    X
                    \arrow[r, "S",  shift left=0.8,  mid vert]
                ...
                \end{tikzcd}
            \]%
            $R\procirc S=R\procirc T$, and let $x\in X$ and $a\in A$ such that $x\sim_{S}a$.
            \begin{itemize}
...
\begin{explanation}{Epimorphisms in $\sfRel$}{explanation-epimorphisms-in-rel}%
    ...
    \begin{itemize}
        ...
        \item \cref{characterisations-of-2-categorical-epimorphisms-in-rel-1,characterisations-of-2-categorical-epimorphisms-in-rel-2} characterise the 2-categorical epimorphisms in $\sfbfRel$.%
            ...
            %---  End Footnote  ---%
    \end{itemize}
    Essentially, an epimorphism $R\colon A\rightproarrow B$ in $\sfRel$ will look like this:
    \begin{webcompile}
        \begin{tikzcd}[row sep={3.0*\the\DL,between origins}, column sep={8.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&,%
                execute at end picture={%
                    % A
                    \draw (\tikzcdmatrixname-4-2) [partial ellipse=0:130:{2.25*\the\DL} and {5.0*\the\DL}];
                    \draw (\tikzcdmatrixname-4-2) [partial ellipse=136.5:140.5:{2.25*\the\DL} and {5.0*\the\DL}];
                    \draw (\tikzcdmatrixname-4-2) [partial ellipse=146:186:{2.25*\the\DL} and {5.0*\the\DL}];
                    \draw (\tikzcdmatrixname-4-2) [partial ellipse=194:202:{2.25*\the\DL} and {5.0*\the\DL}];
                    \draw (\tikzcdmatrixname-4-2) [partial ellipse=211:360:{2.25*\the\DL} and {5.0*\the\DL}];
                    % B
                    ...
                    % (3)
                    \node at (\tikzcdmatrixname-1-1.west -| {-7.0*\the\DL},0) {$\scriptstyle(3)$};%
                    % (1)
            ...
            \arrow[from=3-1,to=3-2,mapsto]%
            \arrow[from=4-1,to=5-2,mapsto]%
            %\arrow[from=5-1,to=4-2,mapsto,crossing over,"\scriptscriptstyle(1)"'{pos=0.885}]%
            \arrow[from=5-1,to=4-2,mapsto,"\scriptscriptstyle(1)"'{pos=0.885}]%
            %%
            %%
            \arrow[from=6-1,to=6-2,"R"']%
        \end{tikzcd}
        \mkern35mu{}%
    \end{webcompile}
    That is, $R$ is a partial surjective function from $A$ to $B$. In particular:
    \begin{enumerate}
        \item\label{explanation-for-result-on-epimorphisms-in-rel-1}$R$ should contain a surjection $f\colon A\twoheadsrightarrow B$.
        \item\label{explanation-for-result-on-epimorphisms-in-rel-2}$R$ doesn't need to be injective, so $R$ can map different elements of $A$ to the same element of $B$.
        \item\label{explanation-for-result-on-epimorphisms-in-rel-3}$R$ can be non-total, so $R$ doesn't need to be defined on all of $A$.
    \end{enumerate}
\end{explanation}
\begin{proposition}{Characterisations of Epimorphisms in $\sfRel$ \rmI}{characterisations-of-epimorphisms-in-rel-1}%
    ...
    \begin{enumerate}
        ...
        \item\label{characterisations-of-epimorphisms-in-rel-1-6}For each pair of relations $S,T\colon B\rightproarrows X$, the following condition is satisfied:
            ...
            \end{itemize}
        \item\label{characterisations-of-epimorphisms-in-rel-1-7}There exists an injective function $f\colon A\hookrightarrow B$ satisfying the following conditions:%
            %--- Begin Footnote ---%
            \footnote{%
            ...
            %---  End Footnote  ---%
            \begin{enumerate}
                \item\label{characterisations-of-epimorphisms-in-rel-1-7-a}We have $\Gr(f)\subset R$.%
                    %--- Begin Footnote ---%
                    \footnote{%
                        In other words, for each $a\in A$, we have $f(a)\in R(a)$.
                    }%
...
\begin{Proof}{Proof of \cref{characterisations-of-epimorphisms-in-rel-1}}%
    ...
    \ProofBox{Warning For Steps 5 and 6}%
    Originally, Steps 5 and 6 of this proof appeared at the end of the proof of the next proposition (\cref{characterisations-of-epimorphisms-in-rel-2}). We will use it for steps 5 and 6, but do note that the proof of the next proposition does not make reference to \cref{characterisations-of-epimorphisms-in-rel-1-7,characterisations-of-epimorphisms-in-rel-1-8} of this proposition, avoiding circular reasoning. If you're checking this proof, please skip the next two steps, read the proof of \cref{characterisations-of-epimorphisms-in-rel-2}, and only then come back to this point.

    \ProofBox{Step 5: \cref{characterisations-of-epimorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-epimorphisms-in-rel-1-7}}%
    We claim that \cref{characterisations-of-epimorphisms-in-rel-2-3} of \cref{characterisations-of-epimorphisms-in-rel-2} is equivalent to \cref{characterisations-of-epimorphisms-in-rel-1-7} of this proposition:
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-2-3} of \cref{characterisations-of-epimorphisms-in-rel-2}$\implies$\cref{characterisations-of-epimorphisms-in-rel-1-7}: }By assumption, given $a\in A$, there exists some $b\in B$ such that $R^{-1}(b)=\{a\}$. Invoking the axiom of choice, we may pick one such $b$ for each $a\in A$, giving us our desired function $f\colon A\to B$. All the requirements listed in \cref{characterisations-of-epimorphisms-in-rel-1-7} then follow by construction.
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1-7}$\implies$\cref{characterisations-of-epimorphisms-in-rel-2-3} of \cref{characterisations-of-epimorphisms-in-rel-2}: }Given $a\in A$, we may pick $b=f(a)$, in which case $R^{-1}(f(a))$ will be equal to $\{a\}$ by assumption.
    \end{itemize}
    By \cref{characterisations-of-epimorphisms-in-rel-2}, \cref{characterisations-of-epimorphisms-in-rel-2-3} of \cref{characterisations-of-epimorphisms-in-rel-2} is equivalent to \cref{characterisations-of-epimorphisms-in-rel-2-1} of \cref{characterisations-of-epimorphisms-in-rel-2}. Since \cref{characterisations-of-epimorphisms-in-rel-2-1} of \cref{characterisations-of-epimorphisms-in-rel-2} is exactly the same condition as \cref{characterisations-of-epimorphisms-in-rel-1-1} of this proposition, the result follows.

    \ProofBox{Step 6: \cref{characterisations-of-epimorphisms-in-rel-1-1}$\iff$\cref{characterisations-of-epimorphisms-in-rel-1-8}}%
    Indeed, we have
    \begin{align*}
        [R_{-1}\circ R^{-1}](U) &\defeq R_{-1}(R^{-1}(U))\\
                               &\defeq \{a\in A\ \middle|\ R(a)\subset R(U)\}%
    \end{align*}
    for each $a\in A$. As a result, the condition $R_{-1}\circ R^{-1}=\id_{\mathcal{P}(A)}$ becomes
    \[
        \{a\in A\ \middle|\ R(a)\subset R(U)\}%
        =%
        U,%
...
\begin{proposition}{Characterisations of Epimorphisms in $\sfRel$ \rmII}{characterisations-of-epimorphisms-in-rel-2}%
    ...
    \begin{enumerate}
        ...
        \item\label{characterisations-of-epimorphisms-in-rel-2-3}For each $b\in B$, there exists some $a\in A$ such that $R^{-1}(b)=\{a\}$.
    \end{enumerate}
    Moreover, if $R$ is an epimorphism, then it satisfies the following condition, and the converse holds if $R$ is functional:
    \begin{enumerate}
        \item\label{characterisations-of-epimorphisms-in-rel-2-4}For each $b\in B$, there exists some $a\in A$ such that $a\sim_{R}b$.
        \item\label{characterisations-of-epimorphisms-in-rel-2-5}We have $\Im(R)=B$.
    \end{enumerate}
\end{proposition}
\begin{Proof}{Proof of \cref{characterisations-of-epimorphisms-in-rel-2}}%
    ...
    \begin{itemize}
        \item Let $a\in A$ and consider the subset $U=A\setminus\{a\}$.
        \item Since $a\nin U$, we have $R(a)\nin R(U)$ by the contrapositve of \cref{characterisations-of-epimorphisms-in-rel-2-2}.
        \item As a result, there must exist some $b\in R(a)$ with $b\nin R(U)$.
        \item In particular, we have $a\in R^{-1}(b)$.
        \item Moreover, the condition $b\nin R(U)=R(A\setminus\{a\})$ means that, if $a'\in R(A\setminus\{a\})$, then $a'\nin R^{-1}(b)$.
        \item Thus $R^{-1}(b)=\{a\}$.
    ...
    We proceed in a few steps:
    \begin{itemize}
        \item By the equivalence between \cref{characterisations-of-epimorphisms-in-rel-1-1,characterisations-of-epimorphisms-in-rel-1-4} of \cref{characterisations-of-epimorphisms-in-rel-1}, to show that $R$ is an epimorphism it suffices to prove that, for each $U,V\in\mathcal{P}(A)$, if $R(U)\subset R(V)$, then $U\subset V$.
        \item So let $u\in U$ and assume $R(U)\subset R(V)$.
        \item By assumption, there exists some $b\in B$ with $R^{-1}(b)=\{u\}$.
        \item In particular, $b\in R(U)$.
        \item Since $R(U)\subset R(V)$, we also have $b\in R(V)$.
    ...
    We claim that $R$ being an epimorphism implies condition ($\star$), and the converse holds if $R$ is total:
    \begin{itemize}
        \item\SloganFont{If $R$ Is an Epimorphism, Then ($\star$) Holds: }Consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    A
                    \arrow[r, "R",mid vert]
            ...
            \begin{itemize}
                ...
                \item Thus condition ($\star$) holds.
            \end{itemize}
        \item\SloganFont{If $R$ Is Functional and ($\star$) Holds, Then $R$ Is an Epimorphism: }Let $U,V\in\mathcal{P}(B)$, consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    A
                    \arrow[r, "R", mid vert]
            ...
            \begin{itemize}
                \item By condition ($\star$), there exists some $a\in A$ such that $a\in R^{-1}(b)$.
                \item Since $R_{-1}(U)=R_{-1}(V)$, \demph{if} $R(a)\subset U$, then $R(a)\subset V$.
...
\begin{remark}{Epimorphisms in $\sfRel$ Give Rise to Antichains}{epimorphisms-in-rel-give-rise-to-antichains}%
    Taking the contrapositive of \cref{characterisations-of-epimorphisms-in-rel-2-2} of \cref{characterisations-of-epimorphisms-in-rel-2} and letting $U=a'$ shows that the subset
    \[
        \{
            R(a)\in\mathcal{P}(B)%
            \ \middle|\ %
...
\begin{proposition}{Characterisations of 2-Categorical Epimorphisms in $\sfbfRel$ \rmII}{characterisations-of-2-categorical-epimorphisms-in-rel-2}%
    ...
    \begin{enumerate}
        ...
        \item\label{characterisations-of-2-categorical-epimorphisms-in-rel-2-2}The 1-morphism $R\colon A\rightproarrow B$ is representably full in $\sfbfRel$.
        \item\label{characterisations-of-2-categorical-epimorphisms-in-rel-2-3}The 1-morphism $R\colon A\rightproarrow B$ is representably fully faithful in $\sfbfRel$.
        \item\label{characterisations-of-2-categorical-epimorphisms-in-rel-2-4}The 1-morphism $R\colon A\rightproarrow B$ is pseudomonic in $\sfbfRel$.
        \item\label{characterisations-of-2-categorical-epimorphisms-in-rel-2-5}The 1-morphism $R\colon A\rightproarrow B$ is representably essentially injective in $\sfbfRel$.
        \item\label{characterisations-of-2-categorical-epimorphisms-in-rel-2-6}The 1-morphism $R\colon A\rightproarrow B$ is representably conservative in $\sfbfRel$.
    \end{enumerate}
\end{proposition}
...
\begin{proposition}{Characterisations of Epimorphisms in $\sfRel$}{characterisations-of-epimorphisms-in-rel}%
    ...
    \begin{enumerate}
        ...
        \item\label{characterisations-of-epimorphisms-in-rel-2}The inverse image function
            \[
                R^{-1}%
                \colon%
                \mathcal{P}(B)%
            ...
            \]%
            associated to $R$ is injective.
        \item\label{characterisations-of-epimorphisms-in-rel-3}The coinverse image function
            \[
                R_{-1}%
                \colon%
                \mathcal{P}(B)%
...
\begin{Proof}{Proof of \cref{characterisations-of-epimorphisms-in-rel}}%
    \FirstProofBox{First Proof of the Equivalence of \cref{characterisations-of-epimorphisms-in-rel-1,characterisations-of-epimorphisms-in-rel-2,characterisations-of-epimorphisms-in-rel-3}}%
    Firstly note that \cref{characterisations-of-epimorphisms-in-rel-2,characterisations-of-epimorphisms-in-rel-3} are equivalent by \cref{properties-of-coinverse-image-functions-associated-to-relations-interaction-with-inverse-images-1} of \cref{properties-of-coinverse-image-functions-associated-to-relations}. We then claim that \cref{characterisations-of-epimorphisms-in-rel-1,characterisations-of-epimorphisms-in-rel-2} are also equivalent:
    \begin{itemize}
    ...
    \ProofBox{Second Proof of the Equivalence of \cref{characterisations-of-epimorphisms-in-rel-1,characterisations-of-epimorphisms-in-rel-2,characterisations-of-epimorphisms-in-rel-3}}%
    A more abstract proof can also be given, following \cite{MSE350788}:
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-1}$\implies$\cref{characterisations-of-epimorphisms-in-rel-2}: }Assume that $R$ is an epimorphism.
            \begin{itemize}
                \item We first notice that the functor $\Rel(-,\pt)\colon\Rel^{\op}\to\Sets$ maps $R$ to $R^{-1}$ by \ChapterRef{\ChapterConstructionsWithRelations, \cref{constructions-with-relations:unwinding-the-inverse-image-function-associated-to-a-relation}}{\cref{unwinding-the-inverse-image-function-associated-to-a-relation}}.
                \item Since $\Rel(-,\pt)$ preserves limits by \ChapterRef{\ChapterLimitsAndColimits, \cref{limits-and-colimits:properties-of-co-limits-commutativity-with-homs} of \cref{limits-and-colimits:properties-of-co-limits}}{\cref{properties-of-co-limits-commutativity-with-homs} of \cref{properties-of-co-limits}}, it follows by \ChapterRef{\ChapterTypesOfMorphismsInCategories, \cref{types-of-morphisms-in-categories:properties-of-epimorphism-preserving-functors-interaction-with-limits} of \cref{types-of-morphisms-in-categories:properties-of-epimorphism-preserving-functors}}{\cref{properties-of-epimorphism-preserving-functors-interaction-with-limits} of \cref{properties-of-epimorphism-preserving-functors}} that $\Rel(-,\pt)$ also preserves epimorphisms.
                \item That is: $\Rel(-,\pt)$ sends epimorphisms in $\Rel^{\op}$ to epimorphisms in $\Sets$.
                \item The epimorphisms $\Rel^{\op}$ are precisely the epimorphisms in $\Rel$ by \ChapterRef{\ChapterTypesOfMorphismsInCategories, \cref{types-of-morphisms-in-categories:properties-of-epimorphisms-duality} of \cref{types-of-morphisms-in-categories:properties-of-epimorphisms}}{\cref{properties-of-epimorphisms-duality} of \cref{properties-of-epimorphisms}}.
                \item Since $R$ is an epimorphism and $\Rel(-,\pt)$ maps $R$ to $R^{-1}$, it follows that $R^{-1}$ is an epimorphism.
    ...
    \ProofBox{Proof of the Equivalence of \cref{characterisations-of-epimorphisms-in-rel-2,characterisations-of-epimorphisms-in-rel-4}}%
    We claim that \cref{characterisations-of-epimorphisms-in-rel-2,characterisations-of-epimorphisms-in-rel-4} are equivalent, following \cite{MO455260}:
    \begin{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-2}$\implies$\cref{characterisations-of-epimorphisms-in-rel-4}: }We proceed in two steps.
            \begin{itemize}
                \item Since $B\setminus\{b\}\subset B$ and $R^{-1}$ is injective, we have $R^{-1}(B\setminus\{b\})\subsetneq R^{-1}(B)$.
                \item Taking some $a\in R^{-1}(B)\setminus R^{-1}(B\setminus\{b\})$, we obtain an element of $A$ such that $R(a)=\{b\}$.
            \end{itemize}
        \item\SloganFont{\cref{characterisations-of-epimorphisms-in-rel-4}$\implies$\cref{characterisations-of-epimorphisms-in-rel-2}: }We proceed in a few steps.
            \begin{itemize}
                \item Let $U,V\subset B$ with $U\neq V$.
                \item Without loss of generality, we can assume $U\setminus V\neq\emptyset$; otherwise just swap $U$ and $V$.
                \item Let then $b\in U\setminus V$.
                \item By assumption, there exists an $a\in A$ with $R(a)=\{b\}$.
                \item Then $a\in R^{-1}(U)$ but $a\nin R^{-1}(V)$, so $R^{-1}(U)\neq R^{-1}(V)$, showing $R^{-1}$ to be injective.
            \end{itemize}
    \end{itemize}

    \ProofBox{Proof of the Second Half of \cref{characterisations-of-epimorphisms-in-rel}}%
    Finally, we prove the second part of the statement. Assume $R$ is a total epimorphism in $\sfRel$ and consider the diagram
    \[
        \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
            A
            \arrow[r, "R",mid vert]
    ...
    for each $b\in B$.
    \begin{itemize}
        \item Since $R$ is total, we have $a\sim_{S\procirc R}0$ and $a\sim_{T\procirc R}0$ for all $a\in A$, and no element of $A$ is related to $1$ by $S\procirc R$ or $T\procirc R$.
        \item Thus $S\procirc R=T\procirc R$.
        \item Since $R$ is an epimorphism, we have $S=T$.
        \item But by the definition of $T$, this implies $\Im(R)=B$.
    \end{itemize}
    This finishes the proof.
\end{Proof}
    ...
    \begin{itemize}
        ...
        \item\SloganFont{\cref{2-categorical-epimorphisms-in-rel-corepresentably-full-morphisms-in-rel-4}$\implies$\cref{2-categorical-epimorphisms-in-rel-corepresentably-full-morphisms-in-rel-6}: }Suppose that the following condition is true:
            ...
            \begin{itemize}
                ...
                \item By \ChapterRef{\ChapterConstructionsWithRelations, \cref{constructions-with-relations:properties-of-coinverse-image-functions-associated-to-relations-interaction-with-inverse-images-1} of \cref{constructions-with-relations:properties-of-coinverse-image-functions-associated-to-relations}}{\cref{properties-of-coinverse-image-functions-associated-to-relations-interaction-with-inverse-images-1} of \cref{properties-of-coinverse-image-functions-associated-to-relations}}, we have
                    \begin{align*}
        ...
        \item\SloganFont{\cref{2-categorical-epimorphisms-in-rel-corepresentably-full-morphisms-in-rel-6}$\implies$\cref{2-categorical-epimorphisms-in-rel-corepresentably-full-morphisms-in-rel-4}: }Suppose that the following condition is true:
            ...
            \begin{itemize}
                ...
                \item By \ChapterRef{\ChapterConstructionsWithRelations, \cref{constructions-with-relations:properties-of-inverse-image-functions-associated-to-relations-interaction-with-coinverse-images-1} of \cref{constructions-with-relations:properties-of-inverse-image-functions-associated-to-relations}}{\cref{properties-of-inverse-image-functions-associated-to-relations-interaction-with-coinverse-images-1} of \cref{properties-of-inverse-image-functions-associated-to-relations}}, we have
                    \begin{align*}
        ...
        \item\SloganFont{\cref{2-categorical-epimorphisms-in-rel-corepresentably-full-morphisms-in-rel-2}$\implies$\cref{2-categorical-epimorphisms-in-rel-corepresentably-full-morphisms-in-rel-4}: }Consider the diagram
            ...
            \]%
            for each $x\in X$, implying $S\subset T$.
        \item\SloganFont{\cref{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-5}$\implies$\cref{2-categorical-monomorphisms-in-rel-representably-full-morphisms-in-rel-2}: }Let $U,V\in\mathcal{P}(B)$ and consider the diagram
            \[
                \begin{tikzcd}[row sep={4.0*\the\DL,between origins}, column sep={4.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                    A
                    \arrow[r, "R",mid vert]
