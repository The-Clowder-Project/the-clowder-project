...
\begin{Proof}{Proof of \cref{conditions-involving-a-relation-and-its-converse-2}}%
    ...
    \begin{center}
        \begin{tabular}{|Sc|Sc|Sc|}\\\hline\rowcolor{darkRed}
            ...
            $R\aptcirc R^{\dagger}\subset \nabla_{B}$            & \Gape[0pt][2pt]{\makecell{For each $b_{1},b_{2}\in B$}} & \Gape[0pt][2pt]{\makecell{If, for each $x\in A$, we have\\$x\sim_{R}b_{1}$ or $x\sim_{R}b_{2}$,\\then $b_{1}\neq b_{2}$.}}  \\\rowcolor{backgroundColor}
            ...
            $R^{\dagger}\aptcirc R\subset \nabla_{A}$            & \Gape[0pt][2pt]{\makecell{For each $a_{1},a_{2}\in A$}} & \Gape[0pt][2pt]{\makecell{If, for each $y\in B$, we have $a_{1}\sim_{R}y$ \\or $a_{2}\sim_{R}y$, then $a_{1}\neq a_{2}$}} \\\hline
        \end{tabular}
    \end{center}
    \endgroup
    Equivalently:
    ...
    \begin{center}
        \begin{tabular}{|Sc|Sc|Sc|}\\\hline\rowcolor{darkRed}
            \textcolor{white}{\textbf{\textsc{Inclusion}}}       & \textcolor{white}{\textbf{\textsc{Quantifier}}}         & \textcolor{white}{\textbf{\textsc{Condition}}}       \\\hline\rowcolor{backgroundColor}
            $R\aptcirc R^{\dagger}\subset \nabla_{B}$            & \Gape[0pt][2pt]{\makecell{For each $b_{1},b_{2}\in B$}} & \Gape[0pt][2pt]{\makecell{if $R^{-1}(b_{1})\cup R^{-1}(b_{2})=A$, then $b_{1}\neq b_{2}$}} \\\rowcolor{backgroundColor}
            $\nabla_{A}           \subset R^{\dagger}\aptcirc R$ & \Gape[0pt][2pt]{\makecell{For each $a_{1},a_{2}\in A$}} & \Gape[0pt][2pt]{\makecell{if $a_{1}\neq a_{2}$, then $R(a_{1})\cup R(a_{2})=B$}}           \\\rowcolor{black!05!backgroundColor}
            $\nabla_{B}           \subset R\aptcirc R^{\dagger}$ & \Gape[0pt][2pt]{\makecell{For each $b_{1},b_{2}\in B$}} & \Gape[0pt][2pt]{\makecell{if $b_{1}\neq b_{2}$, then $R^{-1}(b_{1})\cup R^{-1}(b_{2})=A$}} \\\rowcolor{backgroundColor}
            $R^{\dagger}\aptcirc R\subset \nabla_{A}$            & \Gape[0pt][2pt]{\makecell{For each $a_{1},a_{2}\in A$}} & \Gape[0pt][2pt]{\makecell{if $R(a_{1})\cup R(a_{2})=B$, then $a_{1}\neq a_{2}$}}           \\\hline
        \end{tabular}
    \end{center}
    \endgroup
