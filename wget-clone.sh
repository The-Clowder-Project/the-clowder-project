...
ls web-clone/
#mkdir -p web-clone/127.0.0.1/static/tikzcd-images/dark-mode
#mkdir -p web-clone/127.0.0.1/static/webcompile-images/dark-mode
#mkdir -p web-clone/127.0.0.1/static/scalemath-images/
#mkdir -p web-clone/127.0.0.1/static/scalemath-images/dark-mode
