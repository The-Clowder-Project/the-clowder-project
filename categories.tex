...
\begin{Proof}{Proof of \cref{properties-of-faithful-functors}}%
    ...
    \[
        ...
        \Hom_{\CatFont{D}}(G_{F_{A}},G_{F_{B}}),%
    \]%
    is a composition of injective functions, it follows from \ChapterRef{\ChapterSets, \cref{set-theory:properties-of-injective-functions-interaction-with-composition}}{\cref{properties-of-injective-functions-interaction-with-composition}} that it is also injective. Therefore $G\circ F$ is faithful.
