        ...
        if label in label_tags:
                ...
                if line.find("section-") >= 0 and short.find("phantom") == -1:
                    if line.find(r"-section-") >= 0 and short.find("phantom") == -1:
                        print("\\reversemarginpar\\marginnote{\\texttt{\\href{https://topological-modular-forms.github.io/the-clowder-project/tag/" + label_tags[label] + "}{" + label_tags[label] + "}}}[-1.825\\baselineskip]\\par\\vspace{-0.0\\baselineskip}")
                    if line.find(r'-subsection-') >= 0 and short.find("phantom") == -1:
                        print("\\reversemarginpar\\marginnote{\\texttt{\\href{https://topological-modular-forms.github.io/the-clowder-project/tag/" + label_tags[label] + "}{" + label_tags[label] + "}}}[-1.525\\baselineskip]\\par\\vspace{-0.0\\baselineskip}")
