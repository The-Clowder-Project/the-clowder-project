...
\begin{remark}{Things To Explore/Add}{things-to-explore-add}%
    ...
    \begin{enumerate}
        ...
        \item Associator diagram:
        \[
            \begin{tikzcd}[row sep={2.0*\the\DL,between origins}, column sep={2.0*\the\DL,between origins}, ampersand replacement=\&,execute at end picture={%
                        \foreach \Value/\Name in {%
                            \tikzcdmatrixname-1-5/1-5,%
                            \tikzcdmatrixname-2-2/2-2,%
                            \tikzcdmatrixname-2-8/2-8,%
                            \tikzcdmatrixname-3-4/3-4,%
                            \tikzcdmatrixname-4-1/4-1,%
                            \tikzcdmatrixname-7-6/7-6,%
                            \tikzcdmatrixname-5-9/5-9,%
                            \tikzcdmatrixname-6-3/6-3,%
                            \tikzcdmatrixname-6-7/6-7,%
                            \tikzcdmatrixname-8-1/8-1,%
                            \tikzcdmatrixname-9-4/9-4,%
                            \tikzcdmatrixname-10-2/10-2,%
                            \tikzcdmatrixname-10-8/10-8,%
                            \tikzcdmatrixname-11-5/11-5%
                        }{
                            \coordinate (\Name) at (\Value);
                        }
                    }
                ]
                \&\&\&\&
                ...
                \arrow[from=8-1,to=4-1]%
                \arrow[from=4-1,to=2-2]%
                \arrow[from=2-2,to=1-5]%
                \arrow[from=1-5,to=2-8]%
                \arrow[from=2-8,to=5-9]%
                % Right Boundary
                \arrow[from=10-2,to=11-5]%
                \arrow[from=11-5,to=10-8]%
                \arrow[from=10-8,to=5-9]%
                % Back Face
                \arrow[from=10-2,to=6-3,dashed]%
                \arrow[from=6-3,to=6-7,dashed]%
                \arrow[from=6-3,to=2-2,dashed]%
                \arrow[from=6-7,to=2-8,dashed]%
                \arrow[from=6-7,to=10-8,dashed,bend right = 30,end anchor={[xshift=+0.1em,yshift=-0.15em]}]%
                \arrow[from=6-7,to=10-8,dashed,bend left  = 30,end anchor={[xshift=-0.125em]}]%
                % Front Face
                \arrow[from=8-1,to=9-4,crossing over]%
                \arrow[from=11-5,to=9-4,bend left  = 30,crossing over]%
                \arrow[from=11-5,to=9-4,bend right = 30,crossing over]%
                \arrow[from=9-4,to=7-6,crossing over]%
                \arrow[from=4-1,to=3-4,crossing over]%
                \arrow[from=3-4,to=1-5,crossing over]%
                \arrow[from=3-4,to=7-6,crossing over]%
                \arrow[from=7-6,to=5-9,crossing over]%
            \end{tikzcd}%
        \]%
        \[
            \begin{tikzcd}[row sep={2.0*\the\DL,between origins}, column sep={2.0*\the\DL,between origins}, ampersand replacement=\&,execute at end picture={%
                    ...
                    % Pentagonators
                    \fill[FancyRed,opacity=0.5] (4-1) -- %
                                                (3-4) -- %
                                                (7-6) -- %
                                                ([xshift=0.25em]8-4) -- %
                                                ([xshift=0.15em]7-1) -- %
                                                cycle;
                    \fill[FancyRed,opacity=0.5] (1-5) -- %
                                                (2-8) -- %
                                                (5-9) -- %
                                                ([xshift=-0.05em,yshift=-0.05em]7-6) -- %
                                                (3-4) -- %
                                                cycle;
                    \fill[FancyRed,opacity=0.5] (7-6) -- %
                                                (5-9) -- %
                                                ([xshift=-0.2em]9-8) -- %
                                                ([xshift=0.15em]10-5) to[bend right=40.0] %
                                                ([xshift=0.2em]8-4) -- %
                                                cycle;
                    % Lax Naturality Constraints
                    \fill[OIgreen,opacity=0.5] (2-2) -- %
                                               (1-5) -- %
                                               ([xshift=0.05em,yshift=-0.05em]3-4) -- %
                                               (4-1) -- %
                                               cycle;
                    \fill[OIgreen,opacity=0.5] ([xshift=0.15em]9-2) -- %
                                               ([xshift=0.3em]10-5) to[bend left=40.0] %
                                               ([xshift=0.25em,yshift=0.05em]8-4) -- %
                                               ([xshift=0.15em,yshift=0.05em]7-1) -- %
                                               cycle;
                    % Lax Unity Constraints
                    \fill[FancyYellow,opacity=0.5] ([xshift=0.2em]10-5) to[bend right=40.0] %
                                                   ([xshift=0.225em]8-4) to[bend right=37.0] %
                                                   cycle;
                    }
                ]
                \&\&\&\&
                ...
                \arrow[from=10-8,to=5-9]%
                % Front Face
                \arrow[from=8-1,to=9-4]%
                \arrow[from=11-5,to=9-4,bend left  = 30,""{name=4}]%
                \arrow[from=11-5,to=9-4,bend right = 30,""'{name=5}]%
                \arrow[from=9-4,to=7-6,""{name=3}]%
                \arrow[from=4-1,to=3-4,""{name=2}]%
                \arrow[from=3-4,to=1-5]%
                \arrow[from=3-4,to=7-6]%
                \arrow[from=7-6,to=5-9]%
                % Back Face
                %\arrow[from=9-2,to=6-3,dashed]%
                %\arrow[from=6-3,to=6-7,dashed]%
                %\arrow[from=6-3,to=2-2,dashed]%
                %\arrow[from=6-7,to=2-8,dashed]%
                %\arrow[from=6-7,to=9-8,dashed,bend right = 30]%
                %\arrow[from=6-7,to=9-8,dashed,bend left  = 30,end anchor={[xshift=-0.5em]}]%
                % 2-Arrows
                \arrow[from=2-2,to=3-4, shorten=0.5em,Rightarrow]%
                \arrow[from=1,to=7-6,   shorten=1.5em,Rightarrow,xshift=0.1*\the\DL]%
                \arrow[from=2,to=8-4,   shorten=2.0em,Rightarrow,xshift=0.3*\the\DL,yshift=0.1*\the\DL]%
                \arrow[from=3,to=9-8,   shorten=2.0em,Rightarrow,start anchor={[yshift=0.75*\the\DL]}]%
                \arrow[from=7-1,to=10-5,shorten=3.0em,Rightarrow]%
                \arrow[from=4,to=5,     shorten <= 0.3em,shorten >= 0.2em,Rightarrow]%
            \end{tikzcd}%
            \qquad
            \begin{tikzcd}[row sep={2.0*\the\DL,between origins}, column sep={2.0*\the\DL,between origins}, ampersand replacement=\&,%
                execute at end picture={%
                    ...
                    \fill[FancyRed,opacity=0.5] (2-2) -- %
                                                ...
                                                (6-3) -- %
                                                cycle;
                    \fill[FancyRed,opacity=0.5] ([xshift=+0.225em]9-2) -- %
                                                (6-3) -- %
                                                ([xshift=+0.05em]6-7) to[bend right=38.5] %
                                                ([xshift=-0.25em]9-8) -- %
                                                ([xshift=+0.15em]10-5) -- %
                                                cycle;
                    % Lax Naturality Constraints
                    \fill[OIgreen,opacity=0.5] (2-8) -- %
                                               (6-7) to[bend left=37.5] %
                                               ([xshift=-0.15em]10-8) -- %
                                               ([xshift=+0.025em]10-8) -- %
                                               (5-9) -- %
                                               cycle;
                    % Lax Unity Constraints
                    \fill[FancyYellow,opacity=0.5] ([xshift=0.025em]6-7) to[bend right=38] %
                                                   ([xshift=-0.15em,yshift=0.05em]10-8) --%
                                                   ([xshift=-0.05em,yshift=0.15em]10-8) to[bend right=35] %
                                                   cycle;
                }
            ]
                \&\&\&\&
                ...
                % Left Boundary
                \arrow[from=10-2,to=8-1]%
                \arrow[from=8-1,to=4-1,""{name=1}]%
                \arrow[from=4-1,to=2-2]%
                \arrow[from=2-2,to=1-5,""{name=3}]%
                \arrow[from=1-5,to=2-8]%
                \arrow[from=2-8,to=5-9]%
                % Right Boundary
                \arrow[from=10-2,to=11-5]%
                ...
                %\arrow[from=10-5,to=8-4,bend left  = 30]%
                %\arrow[from=10-5,to=8-4,bend right = 30]%
                %\arrow[from=8-4,to=5-5]%
                %\arrow[from=4-1,to=3-4]%
                %\arrow[from=3-4,to=1-5]%
                %\arrow[from=3-4,to=5-5]%
                %\arrow[from=5-5,to=5-9]%
                % Back Face
                \arrow[from=10-2,to=6-3]%
                \arrow[from=6-3,to=6-7,""{name=2}]%
                \arrow[from=6-3,to=2-2]%
                \arrow[from=6-7,to=2-8]%
                \arrow[from=6-7,to=10-8,""'{name=5},bend right = 30,end anchor={[xshift=+0.1em,yshift=-0.15em]}]%
                \arrow[from=6-7,to=10-8,""{name=4},bend left  = 30,end anchor={[xshift=-0.125em]}]%
                % 2-Arrows
                \arrow[from=1,to=6-3,  shorten <=1.0em,shorten >=0.5em,Rightarrow]%
                \arrow[from=6-5,to=11-5, shorten=1.0em,Rightarrow]%
                \arrow[from=3,to=6-7,  shorten=3.0em,Rightarrow]%
                \arrow[from=2-8,to=9-8,shorten=4.0em,Rightarrow,start anchor={[xshift=0.1*\the\DL]},end anchor={[xshift=-0.05*\the\DL]},yshift=1.0*\the\DL]%
                \arrow[from=4,to=5,    shorten <= 0.3em,shorten >= 0.2em,Rightarrow]%
            \end{tikzcd}
        \]%
        \item Bicategory where objects are groups and a morphism $G\proarrow H$ is a representation of $G^{\op}\times H$. (I.e.\ functors $\B{G}^{\op}\times\B{H}\to\Vect_{k}$).
    ...
    \begin{enumerate}
        ...
        \item finite subgroups of $\SU(2)$, and viewing them as groups of rotations and such
