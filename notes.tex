...
\begin{remark}{Things To Explore/Add}{things-to-explore-add}%
    ...
    \begin{enumerate}
        ...
        \item metric $\lcm(x,y)/\gcd(x,y)$ on $\N$, \url{https://mathoverflow.net/questions/461588/}
    ...
    \begin{enumerate}
        ...
        \item Construction of $\R$ via slopes:
            \begin{enumerate}
                ...
                \item I wonder if one could apply an analogue of this construction to the sphere spectrum and obtain a kind of spectral version of the real numbers, as in e.g.\ following the spirit of \href{MO 443018 --- \textit{Looking for analogues of the rational, $p$-adic, and real numbers in homotopy theory via the passage $\N\to\Z\to\Q\to\R$}}{https://mathoverflow.net/questions/443018}.
            \end{enumerate}
...
In this section we gather some useful examples of \texttt{tikz-cd} code for commutative diagrams.
