...
cp animated.gif ../../../gerby-website/gerby/static/gifs/dark-mode/monoidal-right-unity-of-id-otimes-sets-star.gif
echo "TESTTESTTEST-BEGIN"
ls ../../../gerby-website/gerby/static/gifs/
ls ../../../gerby-website/gerby/static/gifs/dark-mode/
echo "TESTTESTTEST-END"
