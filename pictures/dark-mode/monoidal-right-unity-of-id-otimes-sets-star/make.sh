...
cp animated.gif ../../../gerby-website/gerby/static/gifs/monoidal-right-unity-of-id-otimes-sets-star.gif
cp *.svg ../../../gerby-website/gerby/static/slides/monoidal-right-unity-of-id-otimes-sets-star/dark-mode/
