...
\vspace{-2.0\baselineskip}
        \begin{tikzcd}[row sep={0.0*\the\DL,between origins}, column sep={0.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
            ...
            \&[0.6\ThreeCm]
            \&[0.85\ThreeCm]
            \textcolor{OIblue}{\Unit_{\Sets_{*}}\otimes_{\Sets_{*}}S^{0}}
            \\[1.0*\ThreeCm]
            \&[0.85\ThreeCm]
            S^{0}\wedge X
            \&[0.6\ThreeCm]
            ...
            \arrow[from=1-4,to=2-5,"\id^{\otimes,-1}_{\Unit|\Sets_{*}}\wedge\id_{S^{0}}"{sloped},color=OIblue]%
            % Second Diagram
            ...
            \arrow[from=2-5,to=4-5,"{\id_{\Unit_{\Sets_{*}}}\wedge[x]}",color=OIblue]%
            % Crossing Over
