...
cp animated.gif ../../../gerby-website/gerby/static/gifs/monoidal-left-unity-of-id-otimes-sets.gif
cp *.svg ../../../gerby-website/gerby/static/slides/monoidal-left-unity-of-id-otimes-sets/
