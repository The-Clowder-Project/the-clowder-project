...
\vspace{-2.0\baselineskip}
        \begin{tikzcd}[row sep={0.0*\the\DL,between origins}, column sep={0.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
            ...
            \&[0.6\ThreeCm]
            \&[0.85\ThreeCm]
            \textcolor{OIblue}{\Unit_{\Sets}\otimes_{\Sets}\pt}
            \\[1.0*\ThreeCm]
            \&[0.85\ThreeCm]
            \pt\times A
            \&[0.6\ThreeCm]
            ...
            \arrow[from=1-4,to=2-5,"\id^{\otimes,-1}_{\Unit|\Sets}\times\id_{\pt}"{sloped},color=OIblue]%
            % Second Diagram
            ...
            \arrow[from=2-5,to=4-5,"{\id_{\Unit_{\Sets}}\times[a]}",color=OIblue]%
            % Crossing Over
