...
\begin{center}
    \begin{tabular}{|Sc|Sc|Sc|Sc|}\hline\rowcolor{darkRed}
        ...
        Style 2                           & \code{book}                       & Alegreya Sans                        & \code{amsthm}                                   \\\rowcolor{backgroundColor}
        Style 3                           & \code{book}                       & Alegreya                             & \code{amsthm}                                   \\\rowcolor{black!05!backgroundColor}
        Style 4                           & \code{book}                       & EB Garamond                          & \code{amsthm}                                   \\\rowcolor{backgroundColor}
        Style 5                           & \code{book}                       & Crimson Pro                          & \code{amsthm}                                   \\\rowcolor{black!05!backgroundColor}
        Style 6                           & \code{book}                       & XCharter                             & \code{amsthm}                                   \\\hline
        Style 7                           & \code{book}                       & Computer Modern                      & \code{amsthm}                                   \\\hline
    \end{tabular}
\end{center}
\endgroup
...
\begin{itemize}
    ...
    \item \ChapterRef{\ChapterConstructionsWithSets, \cref{constructions-with-sets:subsection-the-internal-hom-of-a-powerset}}{\cref{subsection-the-internal-hom-of-a-powerset}} contains a discussion of internal Homs in powersets viewed as categories. In general, \ChapterRef{\ChapterConstructionsWithSets, \cref{constructions-with-sets:section-powersets}}{\cref{section-powersets}} discusses several properties of powersets that are analogous to those of presheaf categories.
    ...
    \item \ChapterMonoidalStructuresOnTheCategoryOfSets contains explicit proofs that product/coproduct of sets form a monoidal structure, including a completely 1-categorical proof of the universal property of $(\Sets,\times,\pt)$ (\ChapterRef{\ChapterMonoidalStructuresOnTheCategoryOfSets, \cref{monoidal-structures-on-the-category-of-sets:subsection-the-universal-property-of-sets-times-pt}}{\cref{subsection-the-universal-property-of-sets-times-pt}}).
    \item \ChapterTensorProductsOfPointedSets constructs several tensor products of pointed sets, including a few unusual ones. It also contains a completely 1-categorical proof of the universal property of $(\Sets_{*},\wedge,S^{0})$ (\ChapterRef{\ChapterTensorProductsOfPointedSets, \cref{tensor-products-of-pointed-sets:subsection-the-universal-property-of-the-smash-product-of-pointed-sets}}{\cref{subsection-the-universal-property-of-the-smash-product-of-pointed-sets}}), as well as a description of comonoids in $\Sets_{*}$ with respect to $\wedge$ (\ChapterRef{\ChapterTensorProductsOfPointedSets, \cref{tensor-products-of-pointed-sets:comonoids-with-respect-to-the-smash-product-of-pointed-sets}}{\cref{comonoids-with-respect-to-the-smash-product-of-pointed-sets}})
