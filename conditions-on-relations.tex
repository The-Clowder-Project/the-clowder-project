...
\begin{Proof}{Proof of \cref{properties-of-reflexive-relations}}%
    ...
    To prove $a \sim_{S \procirc R} a$, it suffices to exhibit some $b$ such that $a \sim_R b, b \sim_S a$ (compare \cref{composition-of-relation-1}). Choose $b = a$, then these are satisfied and $S \procirc R$ must be reflexive.
\end{Proof}
