...
\begin{Proof}{Proof of \cref{properties-of-codirect-images-i}}%
    ...
    \begin{itemize}
        \item\SloganFont{Injectivity: }We proceed in a few steps:
            \begin{itemize}
                \item Choosing $U=\{a\}$, we obtain $\{f(a)\}=B\setminus f(X\setminus\{a\})$.
                \item This implies $\{f(a)\}\cap f(X\setminus\{a\})=\emptyset$.
                \item Thus there can be no $a'\in A$ other than $a$ with $f(a')=f(a)$.
            \end{itemize}
        ...
        \item\label{properties-of-injective-functions-characterisations}\SloganFont{Characterisations. }The following conditions are equivalent:%
            ...
            \begin{enumerate}
                ...
                \item\label{properties-of-injective-functions-characterisations-7}The codirect image function
                    ...
                    \]%
                    associated to $f$ is full.
                \item\label{properties-of-injective-functions-characterisations-8}The diagram
                    \[
                        \begin{tikzcd}[row sep={5.0*\the\DL,between origins}, column sep={5.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                            A
                            \arrow[r,"f"]
                ...
                \item\label{properties-of-injective-functions-characterisations-10}We have
                    \begin{webcompile}
                        f^{-1}\circ f_{*}%
                        =%
                        \id_{\mathcal{P}(A)}%
...
\begin{Proof}{Proof of \cref{properties-of-injective-functions}}%
    ...
    \begin{itemize}
        ...
        \item Step 6: \cref{properties-of-injective-functions-characterisations-1}$\iff$\cref{properties-of-injective-functions-characterisations-8}.
        \item Step 7: \cref{properties-of-injective-functions-characterisations-8}$\iff$\cref{properties-of-injective-functions-characterisations-9}.
        \item Step 8: \cref{properties-of-injective-functions-characterisations-1}$\iff$\cref{properties-of-injective-functions-characterisations-10}.
        \item Step 9: \cref{properties-of-injective-functions-characterisations-1}$\implies$\cref{properties-of-injective-functions-characterisations-4}.
    ...
    \SubProofBox{Step 3: \cref{properties-of-injective-functions-characterisations-3}$\iff$\cref{properties-of-injective-functions-characterisations-5}}%
    This follows from \cref{properties-of-direct-images-i-relation-to-codirect-images} of \cref{properties-of-direct-images-i}.

    \SubProofBox{Step 4: \cref{properties-of-injective-functions-characterisations-3}$\iff$\cref{properties-of-injective-functions-characterisations-6}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{properties-of-injective-functions-characterisations-3}$\implies$\cref{properties-of-injective-functions-characterisations-6}: }We proceed in a few steps:
            \begin{itemize}
    ...
    \SubProofBox{Step 5: \cref{properties-of-injective-functions-characterisations-6}$\iff$\cref{properties-of-injective-functions-characterisations-7}}%
    This follows from \cref{properties-of-direct-images-i-relation-to-codirect-images} of \cref{properties-of-direct-images-i}.

    \SubProofBox{Step 6: \cref{properties-of-injective-functions-characterisations-1}$\iff$\cref{properties-of-injective-functions-characterisations-8}}%
    We have
    \[
        f^{-1}(f(a))%
        =%
    ...
    \SubProofBox{Step 7: \cref{properties-of-injective-functions-characterisations-8}$\iff$\cref{properties-of-injective-functions-characterisations-9}}%
    We claim that \cref{properties-of-injective-functions-characterisations-8,properties-of-injective-functions-characterisations-9} are indeed equivalent:
    \begin{itemize}
        \item\SloganFont{\cref{properties-of-injective-functions-characterisations-8}$\implies$\cref{properties-of-injective-functions-characterisations-9}: }We have
            \begin{align*}
        ...
        \item\SloganFont{\cref{properties-of-injective-functions-characterisations-9}$\implies$\cref{properties-of-injective-functions-characterisations-8}: }Applying the condition $f^{-1}\circ f_{!}=\id_{\mathcal{P}(A)}$ to $U=\{a\}$ gives
            \[
                f^{-1}(f_{!}(\{a\}))%
                =%
                \{a\}.%
    ...
    \SubProofBox{Step 8: \cref{properties-of-injective-functions-characterisations-1}$\iff$\cref{properties-of-injective-functions-characterisations-10}}%
    We claim that \cref{properties-of-injective-functions-characterisations-1,properties-of-injective-functions-characterisations-10} are equivalent:
    \begin{itemize}
        \item\SloganFont{\cref{properties-of-injective-functions-characterisations-1}$\implies$\cref{properties-of-injective-functions-characterisations-10}: }If $f$ is injective, then $f^{-1}(f(a))=\{a\}$, so we have
            \begin{align*}
                f^{-1}(f_{*}(a)) &= \{%
                                        a\in A%
                                        \ \middle|\ %
                                 ...
                                 &= U.
            \end{align*}
        \item\SloganFont{\cref{properties-of-injective-functions-characterisations-10}$\implies$\cref{properties-of-injective-functions-characterisations-1}: }For $U=\{a\}$, the condition $f^{-1}(f_{*}(U))=U$ becomes
            \[
                \{%
                    a'\in A%
                    \ \middle|\ %
    ...
    \SubProofBox{Step 9: \cref{properties-of-injective-functions-characterisations-9}$\implies$\cref{properties-of-injective-functions-characterisations-4}}%
    Given $U\in\mathcal{P}(A)$, we must show there exists some $V\in\mathcal{P}(B)$ such that $f^{-1}(V)=U$. Choosing $V=f_{!}(U)$, it follows from \cref{properties-of-injective-functions-characterisations-9} that we have $f^{-1}(f_{!}(U))=U$. Thus $f^{-1}$ is surjective.

    \SubProofBox{Step 10: \cref{properties-of-injective-functions-characterisations-4}$\implies$\cref{properties-of-injective-functions-characterisations-1}}%
        ...
        \item\label{properties-of-surjective-functions-characterisations}\SloganFont{Characterisations. }The following conditions are equivalent:
            \begin{enumerate}
                ...
                \item\label{properties-of-surjective-functions-characterisations-6}The inverse image functor
                    ...
                    \]%
                    associated to $f$ is full.
                \item\label{properties-of-surjective-functions-characterisations-7}The diagram
                    \[
                        \begin{tikzcd}[row sep={5.0*\the\DL,between origins}, column sep={5.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                            B
                            \arrow[r,"f^{-1}"]
                    ...
                    \]%
                    for each $b\in B$.
                \item\label{properties-of-surjective-functions-characterisations-8}We have
                    \begin{webcompile}
                        f_{!}\circ f^{-1}%
                        =%
                        \id_{\mathcal{P}(B)}%
                    ...
                    \]%
                    for each $U\in\mathcal{P}(A)$.%
                \item\label{properties-of-surjective-functions-characterisations-9}We have
                    \begin{webcompile}
                        f_{*}\circ f^{-1}%
                        =%
                        \id_{\mathcal{P}(B)}%
...
\begin{Proof}{Proof of \cref{properties-of-surjective-functions}}%
    ...
    \begin{itemize}
        ...
        \item Step 4: \cref{properties-of-surjective-functions-characterisations-1}$\iff$\cref{properties-of-surjective-functions-characterisations-7}.
        \item Step 5: \cref{properties-of-surjective-functions-characterisations-7}$\iff$\cref{properties-of-surjective-functions-characterisations-8}.
        \item Step 6: \cref{properties-of-surjective-functions-characterisations-1}$\iff$\cref{properties-of-surjective-functions-characterisations-9}.
        \item Step 7: \cref{properties-of-surjective-functions-characterisations-8}$\iff$\cref{properties-of-surjective-functions-characterisations-4}.
    ...
    \SubProofBox{Step 3: \cref{properties-of-surjective-functions-characterisations-3}$\iff$\cref{properties-of-surjective-functions-characterisations-6}}%
    ...
    \begin{itemize}
        \item\SloganFont{\cref{properties-of-surjective-functions-characterisations-3}$\implies$\cref{properties-of-surjective-functions-characterisations-6}: }We proceed in a few steps:
            \begin{itemize}
                ...
                \item Thus $U\subset V$, as we wished to show.
            \end{itemize}
        \item\SloganFont{\cref{properties-of-surjective-functions-characterisations-6}$\implies$\cref{properties-of-surjective-functions-characterisations-3}: }We proceed in a few steps:
            \begin{itemize}
    ...
    \SubProofBox{Step 4: \cref{properties-of-surjective-functions-characterisations-1}$\iff$\cref{properties-of-surjective-functions-characterisations-7}}%
    We have
    \[
        f_{!}(f^{-1}(b))%
        =%
    ...
    \SubProofBox{Step 5: \cref{properties-of-surjective-functions-characterisations-7}$\iff$\cref{properties-of-surjective-functions-characterisations-8}}%
    We claim that \cref{properties-of-surjective-functions-characterisations-7,properties-of-surjective-functions-characterisations-8} are indeed equivalent:
    \begin{itemize}
        \item\SloganFont{\cref{properties-of-surjective-functions-characterisations-7}$\implies$\cref{properties-of-surjective-functions-characterisations-8}: }We have
            \begin{align*}
        ...
        \item\SloganFont{\cref{properties-of-surjective-functions-characterisations-8}$\implies$\cref{properties-of-surjective-functions-characterisations-7}: }Applying the condition $f_{!}\circ f^{-1}=\id_{\mathcal{P}(B)}$ to $U=\{b\}$ gives
            \[
                f_{!}(f^{-1}(\{b\}))%
                =%
                \{b\}.%
    ...
    \SubProofBox{Step 6: \cref{properties-of-surjective-functions-characterisations-1}$\iff$\cref{properties-of-surjective-functions-characterisations-9}}%
    ...
    \[
        ...
        (B\setminus\Im(f)).%
    \]%
    We now claim that \cref{properties-of-surjective-functions-characterisations-1,properties-of-surjective-functions-characterisations-9} are indeed equivalent:
    \begin{itemize}
        \item\SloganFont{\cref{properties-of-surjective-functions-characterisations-1}$\implies$\cref{properties-of-surjective-functions-characterisations-9}: }If $f$ is surjective, we have
            \begin{align*}
                (U\cap\Im(f))\cup(B\setminus\Im(f)) &= U\cup\emptyset\\
                                                    &= U,
            \end{align*}
            so $f_{*}\circ f^{-1}=\id_{\mathcal{P}(B)}$.
        \item\SloganFont{\cref{properties-of-surjective-functions-characterisations-9}$\implies$\cref{properties-of-surjective-functions-characterisations-1}: }Taking $U=\emptyset$ gives
            \begin{align*}
    ...
    \SubProofBox{Step 8: \cref{properties-of-surjective-functions-characterisations-8}$\iff$\cref{properties-of-surjective-functions-characterisations-4}}%
    Given $V\in\mathcal{P}(B)$, we must show there exists some $U\in\mathcal{P}(A)$ such that $f_{!}(U)=V$. Choosing $U=f^{-1}(V)$, it follows from \cref{properties-of-surjective-functions-characterisations-8} that we have $f_{!}(f^{-1}(V))=V$. Thus $f_{!}$ is surjective.

    \SubProofBox{Step 9: \cref{properties-of-surjective-functions-characterisations-4}$\iff$\cref{properties-of-surjective-functions-characterisations-1}}%
    ...
    \SubProofBox{Step 10: \cref{properties-of-surjective-functions-characterisations-4}$\iff$\cref{properties-of-surjective-functions-characterisations-5}}%
    This follows from \cref{properties-of-direct-images-i-relation-to-codirect-images} of \cref{properties-of-direct-images-i}.
        ...
        \item\label{properties-of-bijective-functions-characterisations}\SloganFont{Characterisations. }The following conditions are equivalent:
            \begin{enumerate}
                ...
                \item\label{properties-of-bijective-functions-characterisations-7}The codirect image function
                    ...
                    \]%
                    associated to $f$ is bijective.
                \item\label{properties-of-bijective-functions-characterisations-8}We have
                    \begin{webcompile}
                        \begin{tikzcd}[row sep={5.0*\the\DL,between origins}, column sep={5.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                            A
                            \arrow[r,"f"]
                    ...
                    \end{align*}
                    for each $a\in A$ and each $b\in B$.
                \item\label{properties-of-bijective-functions-characterisations-9}We have
                    \begin{webcompile}
                        \begin{tikzcd}[row sep={5.0*\the\DL,between origins}, column sep={5.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                            \mathcal{P}(A)
                            \arrow[r,"f_{!}"]
                        ...
                        \end{tikzcd}
                    \end{webcompile}
                \item\label{properties-of-bijective-functions-characterisations-10}We have
                    \begin{webcompile}
                        \begin{tikzcd}[row sep={5.0*\the\DL,between origins}, column sep={5.0*\the\DL,between origins}, background color=backgroundColor, ampersand replacement=\&]
                            \mathcal{P}(A)
                            \arrow[r,"f_{*}"]
...
\begin{Proof}{Proof of \cref{properties-of-bijective-functions}}%
    ...
    \begin{itemize}
        ...
        \item Step 7: \cref{properties-of-bijective-functions-characterisations-1}$\iff$\cref{properties-of-bijective-functions-characterisations-8}.
        \item Step 8: \cref{properties-of-bijective-functions-characterisations-1}$\iff$\cref{properties-of-bijective-functions-characterisations-9}.
        \item Step 9: \cref{properties-of-bijective-functions-characterisations-1}$\iff$\cref{properties-of-bijective-functions-characterisations-10}.
    \end{itemize}
    ...
    \SubProofBox{Step 7: \cref{properties-of-bijective-functions-characterisations-1}$\iff$\cref{properties-of-bijective-functions-characterisations-8}}%
    This follows from \cref{properties-of-injective-functions-characterisations-8} of \cref{properties-of-injective-functions-characterisations} of \cref{properties-of-injective-functions} and \cref{properties-of-surjective-functions-characterisations-7} of \cref{properties-of-surjective-functions-characterisations} of \cref{properties-of-surjective-functions}.

    \SubProofBox{Step 8: \cref{properties-of-bijective-functions-characterisations-1}$\iff$\cref{properties-of-bijective-functions-characterisations-9}}%
    This follows from \cref{properties-of-injective-functions-characterisations-9} of \cref{properties-of-injective-functions-characterisations} of \cref{properties-of-injective-functions} and \cref{properties-of-surjective-functions-characterisations-8} of \cref{properties-of-surjective-functions-characterisations} of \cref{properties-of-surjective-functions}.

    \SubProofBox{Step 9: \cref{properties-of-bijective-functions-characterisations-1}$\iff$\cref{properties-of-bijective-functions-characterisations-9}}%
    This follows from \cref{properties-of-injective-functions-characterisations-10} of \cref{properties-of-injective-functions-characterisations} of \cref{properties-of-injective-functions} and \cref{properties-of-surjective-functions-characterisations-9} of \cref{properties-of-surjective-functions-characterisations} of \cref{properties-of-surjective-functions}.
