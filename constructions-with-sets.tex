...
\begin{Proof}{Proof of \cref{properties-of-products-of-sets}}%
    ...
    \begin{itemize}
        ...
        \item\label{proof-of-properties-of-products-of-sets-adjointness-1-6}\SloganFont{Naturality for $\Phi$, Part \rmII. }We need to show that, given a function $h\colon C\to C'$, the diagram
            ...
            we have
            \begin{align*}
                [\Phi_{B,C}\circ h_{!}](\xi) &= \Phi_{B,C}(h_{kkkkkk}(\xi))\\
                                             ...
                                             &= (h_{!})_{kkkkkk}(\llbracket a\mapsto\llbracket b\mapsto\xi(a,b)\rrbracket\rrbracket)\\
                                             &= (h_{!})_{kkkkkk}(\Phi_{B,C}(\llbracket(a,b)\mapsto\xi(a,b)\rrbracket))\\
                                             &= (h_{!})_{kkkkkk}(\Phi_{B,C}(\xi))\\
                                             &= [(h_{!})_{kkkkkk}\circ\Phi_{B,C}](\xi).
            \end{align*}
...
\begin{proposition}{Properties of Unions of Families of Subsets}{properties-of-unions-of-families-of-subsets}%
    ...
    \begin{enumerate}
        ...
        \item\label{properties-of-unions-of-families-of-subsets-interaction-with-direct-images}\SloganFont{Interaction With Direct Images. }Let $f\colon X\to Y$ be a map of sets. The diagram
            ...
            \]%
            for each $\mathcal{U}\in\mathcal{P}(X)$, where $f_{!}(\mathcal{U})\defeq(f_{kkkkkk})_{kkkkkk}(\mathcal{U})$.
    ...
    \begin{enumerate}
        ...
        \item\label{properties-of-powersets-as-categories-interaction-with-products-1}\SloganFont{Interaction With Products \rmI. }The map
            \begin{webcompile}
                ...
                \end{tikzcd}
            \end{webcompile}%
            is an isomorphism of sets, natural in $X,Y\in\Obj(\Sets)$ with respect to each of the functor structures $\mathcal{P}_{!}$, $\mathcal{P}^{-1}$, and $\mathcal{P}_{*}$ on $\mathcal{P}$ of \cref{functoriality-of-powersets}. Moreover, this makes each $\mathcal{P}_{kkkkkk}$, $\mathcal{P}^{-1}$, and $\mathcal{P}_{*}$ into a symmetric monoidal functor.
        \item\label{properties-of-powersets-as-categories-interaction-with-products-2}\SloganFont{Interaction With Products \rmII. }The map
            ...
            \[
                ...
                \}%
            \]%
            is an inclusion of sets, natural in $X,Y\in\Obj(\Sets)$ with respect to each of the functor structures $\mathcal{P}_{!}$, $\mathcal{P}^{-1}$, and $\mathcal{P}_{*}$ on $\mathcal{P}$ of \cref{functoriality-of-powersets}. Moreover, this makes each of $\mathcal{P}_{kkkkkk}$, $\mathcal{P}^{-1}$, and $\mathcal{P}_{*}$ into a symmetric monoidal functor.
        \item\label{properties-of-powersets-as-categories-interaction-with-products-3}\SloganFont{Interaction With Products \rmIII. }We have an isomorphism
            \[
                ...
                \mathcal{P}(X\times Y),%
            \]%
            natural in $X,Y\in\Obj(\Sets)$ with respect to each of the functor structures $\mathcal{P}_{!}$, $\mathcal{P}^{-1}$, and $\mathcal{P}_{*}$ on $\mathcal{P}$ of \cref{functoriality-of-powersets}, where $\otimes$ denotes the tensor product of suplattices of \cref{TODO}. Moreover, this makes each of $\mathcal{P}_{kkkkkk}$, $\mathcal{P}^{-1}$, and $\mathcal{P}_{*}$ into a symmetric monoidal functor.
...
\begin{Proof}{Proof of \cref{powersets-as-free-cocompletions-adjointness}}%
    ...
    commutes. Indeed, we have
    \begin{align*}
        [\Phi_{X,Y}\circ\mathcal{P}_{!}(f)^{*}](\xi) &\defeq  \Phi_{X,Y}(\mathcal{P}_{kkkkkk}(f)^{*}(\xi))\\
    ...
    commutes. Indeed, we have
    \begin{align*}
        [\Phi_{X,Y'}\circ g_{!}](\xi) &\defeq \Phi_{X,Y'}(g_{kkkkkk}(\xi))\\
...
\begin{Proof}{Proof of \cref{isbell-duality-for-sets}}%
    We have
    \begin{align*}
        \IsbellI_{!}(\IsbellI(U)) &\defeq \IsbellI_{kkkkkk}(\llbracket x\mapsto U^{\sfc}\cup\{x\}\rrbracket)\\
...
\begin{Proof}{Proof of \cref{properties-of-characteristic-embeddings}}%
    ...
    Indeed, we have
    \begin{align*}
        [f_{!}\circ\chi_{X}](x) &\defeq f_{kkkkkk}(\chi_{X}(x))\\%
                                &\defeq f_{!}(\{x\})\\%
                                &=      \{f(x)\}\\%
                                &\defeq \chi_{X'}(f(x))\\%
...
\begin{warning}{Notation for Direct Images Is Confusing}{notation-for-direct-images-is-confusing}%
    ...
    \begin{enumerate}
        \item\label{notation-for-direct-images-is-confusing-1}Direct images for powersets and presheaves are both adjoint to their corresponding inverse image functors. However, the direct image functor for powersets is a left adjoint, while the direct image functor for presheaves is a right adjoint:
            \begin{enumerate}
    ...
    \begin{center}
        \begin{tabular}{|Sc|Sc|}\hline\rowcolor{darkRed}
            ...
            Functoriality of Powersets                     & $(f_{!}\dashv f^{-1}\dashv f_{*})\colon\mathcal{P}(X)\rightleftrightarrows\mathcal{P}(Y)$                              \\\rowcolor{black!05!backgroundColor}
            Functoriality of Presheaf Categories           & $(f_{!}\dashv f^{-1}\dashv f_{*})\colon\PSh(X)\rightleftrightarrows\PSh(Y)$                                            \\\rowcolor{backgroundColor}
...
\begin{proposition}{Properties of Direct Images \rmI}{properties-of-direct-images-i}%
    ...
    \begin{enumerate}
        \item\label{properties-of-direct-images-i-functoriality}\SloganFont{Functoriality. }The assignment $U\mapsto f_{!}(U)$ defines a functor
            ...
            \begin{itemize}
                \itemstar If $U\subset V$, then $f_{!}(U)\subset f_{kkkkkk}(V)$.
            \end{itemize}
        ...
        \item\label{properties-of-direct-images-i-preservation-of-colimits}\SloganFont{Preservation of Colimits. }We have an equality of sets
            ...
            \[
                \begin{gathered}
                    f_{!}(U)\cup f_{kkkkkk}(V)                  = f_{kkkkkk}(U\cup V),\\
        ...
        \item\label{properties-of-direct-images-i-oplax-preservation-of-limits}\SloganFont{Oplax Preservation of Limits. }We have an inclusion of sets
            ...
            \[
                \begin{gathered}
                    f_{!}(U\cap V) \subset f_{kkkkkk}(U)\cap f_{kkkkkk}(V),\\
                    f_{!}(X)        \subset Y,
                \end{gathered}
            \]%
            natural in $U,V\in\mathcal{P}(X)$.
        \item\label{properties-of-direct-images-i-symmetric-strict-monoidality-with-respect-to-unions}\SloganFont{Symmetric Strict Monoidality With Respect to Unions. }The direct image function of \cref{properties-of-direct-images-i-functoriality} has a symmetric strict monoidal structure
            \[
                (f_{!},f^{\otimes}_{kkkkkk},f^{\otimes}_{*|\Unit})
                \colon
            ...
            \[
                \begin{gathered}
                    f^{\otimes}_{*|U,V}   \colon f_{!}(U)\cup f_{kkkkkk}(V) \rightequalsarrow f_{kkkkkk}(U\cup V),\\
        ...
        \item\label{properties-of-direct-images-i-symmetric-oplax-monoidality-with-respect-to-intersections}\SloganFont{Symmetric Oplax Monoidality With Respect to Intersections. }The direct image function of \cref{properties-of-direct-images-i-functoriality} has a symmetric oplax monoidal structure
            ...
            \[
                \begin{gathered}
                    f^{\otimes}_{*|U,V}   \colon f_{!}(U\cap V) \hookrightarrow f_{kkkkkk}(U)\cap f_{kkkkkk}(V),\\
        ...
        \item\label{properties-of-direct-images-i-interaction-with-products}\SloganFont{Interaction With Products. }Let $f\colon X\to X'$ and $g\colon Y\to Y'$ be maps of sets. We have
            \[
                ...
                =%
                f_{!}(U)\boxtimes_{X'\times Y'}g_{kkkkkk}(V)%
            \]%
            for each $U\in\mathcal{P}(X)$ and each $V\in\mathcal{P}(Y)$.
...
\begin{Proof}{Proof of \cref{properties-of-direct-images-i}}%
    ...
    We have
    \begin{align*}
        \bigcup_{V\in f_{!}(\mathcal{U})}V &= \bigcup_{V\in\{f_{kkkkkk}(U)\in\mathcal{P}(X)\ \middle|\ U\in\mathcal{U}\}}V\\
                                           &= \bigcup_{U\in\mathcal{U}}f_{!}(U).%
    \end{align*}
    This finishes the proof.
    ...
    We have
    \begin{align*}
        \bigcap_{V\in f_{!}(\mathcal{U})}V &= \bigcap_{V\in\{f_{kkkkkk}(U)\in\mathcal{P}(X)\ \middle|\ U\in\mathcal{U}\}}V\\
                                           &= \bigcap_{U\in\mathcal{U}}f_{!}(U).%
    \end{align*}
    This finishes the proof.
    ...
    \begin{align*}
        f_{!}(U^{\sfc}) &= f_{kkkkkk}(X\setminus U)\\
    ...
    We have
    \begin{align*}
        f_{!}(U)\sdiff f_{kkkkkk}(V) &=       (f_{kkkkkk}(U)\cup f_{kkkkkk}(V))\setminus(f_{kkkkkk}(U)\cap f_{kkkkkk}(V))\\
                                &\subset (f_{!}(U)\cup f_{kkkkkk}(V))\setminus(f_{kkkkkk}(U\cap V))\\
                                &=       (f_{!}(U\cup V))\setminus(f_{kkkkkk}(U\cap V))\\
    ...
    We have
    \begin{align*}
        f_{!}([U,V]_{X}) &\defeq f_{kkkkkk}(U^{\sfc}\cup V)\\
                         &=      f_{!}(U^{\sfc})\cup f_{kkkkkk}(V)\\
                         &=      f_{*}(U)^{\sfc}\cup f_{!}(V)\\
                         &\defeq [f_{*}(U),f_{!}(V)]_{Y},%
    \end{align*}
    where we have used:
    \begin{enumerate}
        ...
        \item\label{proof-of-properties-of-direct-images-i-interaction-with-internal-homs-of-powersets-2}\cref{properties-of-direct-images-i-relation-to-direct-images-with-compact-support} for the third equality.
    \end{enumerate}
    Since $\mathcal{P}(Y)$ is posetal, naturality is automatic (\ChapterRef{\ChapterCategories, \cref{categories:properties-of-posetal-categories-automatic-commutativity-of-diagrams} of \cref{categories:properties-of-posetal-categories}}{\cref{categories:properties-of-posetal-categories-automatic-commutativity-of-diagrams} of \cref{categories:properties-of-posetal-categories}}). This finishes the proof.
    ...
    \begin{align*}
        f_{!}(U) &= B\setminus(B\setminus f_{kkkkkk}(U)),\\
...
\begin{example}{Examples of Direct Images With Compact Support}{examples-of-direct-images-with-compact-support}%
    ...
    \begin{enumerate}
        \item\label{examples-of-direct-images-with-compact-support-multiplication-by-two}\SloganFont{The Multiplication by Two Map on the Natural Numbers. }Consider the function $f\colon\N\to\N$ given by
            \[
                f(n)
                \defeq
                2n
            ...
            \end{align*}
            for any $U\subset\N$.
        \item\label{examples-of-direct-images-with-compact-support-parabolas}\SloganFont{Parabolas. }Consider the function $f\colon\R\to\R$ given by
            \[
                f(x)%
                \defeq%
                x^{2}
            ...
            \end{gather*}
        \item\label{examples-of-direct-images-with-compact-support-circles}\SloganFont{Circles. }Consider the function $f\colon\R^{2}\to\R$ given by
            \[
                f(x,y)%
                \defeq%
                x^{2}+y^{2}
...
\begin{Proof}{Proof of \cref{properties-of-direct-images-with-compact-support-i}}%
    ...
    We have
    \begin{align*}
        f_{*}(U)\cup f_{*}(V) &=       f_{!}(U^{\sfc})^{\sfc}\cup f_{kkkkkk}(V^{\sfc})^{\sfc}\\
                              &=       (f_{!}(U^{\sfc})\cap f_{kkkkkk}(V^{\sfc}))^{\sfc}\\
    ...
    where:
    \begin{enumerate}
        \item\label{proof-of-properties-of-direct-images-with-compact-support-i-interaction-with-binary-unions-1}We have used \cref{properties-of-direct-images-with-compact-support-i-relation-to-direct-images} for the first equality.
        \item\label{proof-of-properties-of-direct-images-with-compact-support-i-interaction-with-binary-unions-2}We have used \cref{properties-of-complements-de-morgan-s-laws} of \cref{properties-of-complements} for the second equality.
        \item\label{proof-of-properties-of-direct-images-with-compact-support-i-interaction-with-binary-unions-3}We have used \cref{properties-of-direct-images-i-interaction-with-binary-intersections} of \cref{properties-of-direct-images-i} for the third equality.
        \item\label{proof-of-properties-of-direct-images-with-compact-support-i-interaction-with-binary-unions-4}We have used \cref{properties-of-complements-de-morgan-s-laws} of \cref{properties-of-complements} for the fourth equality.
        \item\label{proof-of-properties-of-direct-images-with-compact-support-i-interaction-with-binary-unions-5}We have used \cref{properties-of-direct-images-with-compact-support-i-relation-to-direct-images} for the last equality.
    \end{enumerate}
    This finishes the proof.
    ...
    We have
    \begin{align*}
        \big[f_{!}(U),f^{!}(V)\big]_{X} &\defeq  f_{kkkkkk}(U)^{\sfc}\cup f_{*}(V)\\
                                        &=       f_{*}(U^{\sfc})\cup f_{*}(V)\\
    ...
    where we have used:
    \begin{enumerate}
        \item\label{proof-of-properties-of-direct-images-with-compact-support-i-interaction-with-internal-homs-of-powersets-1}\cref{properties-of-direct-images-with-compact-support-i-interaction-with-complements} of \cref{properties-of-direct-images-with-compact-support-i} for the second equality.
        \item\label{proof-of-properties-of-direct-images-with-compact-support-i-interaction-with-internal-homs-of-powersets-2}\cref{properties-of-direct-images-with-compact-support-i-interaction-with-binary-unions} of \cref{properties-of-direct-images-with-compact-support-i} for the inclusion.
    \end{enumerate}
    Since $\mathcal{P}(X)$ is posetal, naturality is automatic (\ChapterRef{\ChapterCategories, \cref{categories:properties-of-posetal-categories-automatic-commutativity-of-diagrams} of \cref{categories:properties-of-posetal-categories}}{\cref{categories:properties-of-posetal-categories-automatic-commutativity-of-diagrams} of \cref{categories:properties-of-posetal-categories}}). This finishes the proof.
    ...
    \begin{enumerate}
        \item\label{a-six-functor-formalism-for-sets-the-beck-chevalley-condition}\SloganFont{The Beck--Chevalley Condition. }Let
            ...
            \begin{scalemath}
                ...
                \quad
                \begin{aligned}
                    g^{-1}\circ f_{!} &= (\pr_{2})_{kkkkkk}\circ\pr^{-1}_{1},\\%
                    f^{-1}\circ g_{!} &= (\pr_{1})_{kkkkkk}\circ\pr^{-1}_{2},%
                \end{aligned}
                \quad%
                \begin{tikzcd}[row sep={5.0*\the\DL,between origins}, column sep={6.5*\the\DL,between origins}, background color=backgroundZolor, ampersand replacement=\&]
                    \mathcal{P}(X)
        ...
        \item\label{a-six-functor-formalism-for-sets-the-external-tensor-product}\SloganFont{The External Tensor Product. }We have an external tensor product
            ...
            \begin{enumerate}
                \item\label{a-six-functor-formalism-for-sets-the-external-tensor-product-interaction-with-direct-images}\SloganFont{Interaction With Direct Images. }Let $f\colon X\to X'$ and $g\colon Y\to Y'$ be functions. The diagram
                    ...
                    commutes, i.e.\ we have
                    \[
                        [f_{!}\times g_{kkkkkk}](U\boxtimes_{X\times Y}V)%
                        =%
                        f_{!}(U)\boxtimes_{X'\times Y'}g_{kkkkkk}(V)%
                    \]%
...
\begin{Proof}{Proof of \cref{a-six-functor-formalism-for-sets}}%
    ...
    We have
    \begin{align*}
        [g^{-1}\circ f_{!}](U) &\defeq g^{-1}(f_{kkkkkk}(U))\\
    ...
    \begin{align*}
        [f^{-1}\circ g_{!}](U) &\defeq f^{-1}(g_{kkkkkk}(U))\\
    ...
    Indeed, we have
    \begin{align*}
        f_{!}(U)\cap V &\subset f_{kkkkkk}(U)\cap f_{kkkkkk}(f^{-1}(V))\\
                       &=       f_{!}(U\cap f^{-1}(V)),
    \end{align*}
    where we have used:
    \begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item\label{proof-of-a-six-functor-formalism-for-sets-the-projection-formula-1-7}Since $f(x)\in f_{!}(U)$ and $f(x)\in V$, we have $f(x)\in f_{kkkkkk}(U)\cap V$.
        \item\label{proof-of-a-six-functor-formalism-for-sets-the-projection-formula-1-8}But $y=f(x)$, so $y\in f_{!}(U)\cap V$.
        \item\label{proof-of-a-six-functor-formalism-for-sets-the-projection-formula-1-9}Thus $f_{!}(U\cap f^{-1}(V))\subset f_{kkkkkk}(U)\cap V$.%
    \end{enumerate}
    This finishes the proof.
    ...
    where we have used:
    \begin{enumerate}
        \item\label{proof-of-a-six-functor-formalism-for-sets-the-projection-formula-2-1}\cref{properties-of-direct-images-with-compact-support-i-triple-adjointness} of \cref{properties-of-direct-images-with-compact-support-i} for the inclusion.
        \item\label{proof-of-a-six-functor-formalism-for-sets-the-projection-formula-2-2}\cref{properties-of-direct-images-with-compact-support-i-interaction-with-binary-intersections} of \cref{properties-of-direct-images-with-compact-support-i} for the equality.
    \end{enumerate}
    Since $\mathcal{P}(Y)$ is posetal, naturality is automatic (\ChapterRef{\ChapterCategories, \cref{categories:properties-of-posetal-categories-automatic-commutativity-of-diagrams} of \cref{categories:properties-of-posetal-categories}}{\cref{categories:properties-of-posetal-categories-automatic-commutativity-of-diagrams} of \cref{categories:properties-of-posetal-categories}}).
