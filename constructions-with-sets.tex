...
\begin{remark}{Intuition for the Internal Hom of $\mathcal{P}(X)$}{intuition-for-the-internal-hom-of-px}%
    ...
    \begin{enumerate}
        ...
        \item\label{intuition-for-the-internal-hom-of-px-2}Under the Curry--Howard correspondence (\cref{TODO}), the function type $[U,V]$ corresponds to implication $U\Rightarrow V$.
