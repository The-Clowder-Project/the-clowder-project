...
```
Then, run `conda-create`, activate the new conda environment via `conda activate clowder_py36_env`, and then run `make init`, which will install all required dependencies.
